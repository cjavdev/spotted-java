...
dependencies {
    testImplementation(project(":spotted-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../spotted-java-core/src/main/resources/META-INF/proguard/spotted-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("dev.cjav.spotted.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../spotted-java-core/src/main/resources/META-INF/proguard/spotted-java-core.pro",
