...
Full Changelog: [v0.28.0...v0.29.0](https://github.com/cjavdev/spotted-java/compare/v0.28.0...v0.29.0)

### Features

* **stlc:** configurable CI runner and private-production-repo support in workflow templates ([a5ab28b](https://github.com/cjavdev/spotted-java/commit/a5ab28b6ab95b79eef61a7611faf79ea360aee21))
...
* **api:** api update ([c285429](https://github.com/cjavdev/spotted-java/commit/c285429bcd13d9d3bce205070420af77569b82af))
...
* **api:** api update ([918a416](https://github.com/cjavdev/spotted-java/commit/918a4167dfc6ab72efba56de1829e4d06c545898))

## 0.20.0 (2026-02-12)

Full Changelog: [v0.19.0...v0.20.0](https://github.com/cjavdev/spotted-java/compare/v0.19.0...v0.20.0)

### Features

* **api:** api update ([02eef57](https://github.com/cjavdev/spotted-java/commit/02eef57119e210d6435a8f1657c20d1b4147eb5a))
