...
import com.spotted.api.client.SpottedClientImpl
...
/**
 * A class that allows building an instance of [SpottedClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class SpottedOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [SpottedClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): SpottedClient = builder().fromEnv().build()
    }

    /** A builder for [SpottedOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [SpottedClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SpottedClient =
            SpottedClientImpl(
                clientOptions
                    .httpClient(
