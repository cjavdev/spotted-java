...
package com.spotted.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.spotted.api.client.SpottedClientAsync
import com.spotted.api.client.SpottedClientAsyncImpl
import com.spotted.api.core.ClientOptions
import com.spotted.api.core.Sleeper
import com.spotted.api.core.Timeout
import com.spotted.api.core.http.AsyncStreamResponse
import com.spotted.api.core.http.Headers
import com.spotted.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [SpottedClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class SpottedOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [SpottedClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): SpottedClientAsync = builder().fromEnv().build()
    }

    /** A builder for [SpottedOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.spotted.api.core.jsonMapper]. The default is usually sufficient and
        ...
        /**
         * Returns an immutable instance of [SpottedClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SpottedClientAsync =
            SpottedClientAsyncImpl(
                clientOptions
                    .httpClient(
