...
[![Maven Central](https://img.shields.io/maven-central/v/dev.cjav.spotted/spotted-java)](https://central.sonatype.com/artifact/dev.cjav.spotted/spotted-java/0.9.0)
[![javadoc](https://javadoc.io/badge2/dev.cjav.spotted/spotted-java/0.9.0/javadoc.svg)](https://javadoc.io/doc/dev.cjav.spotted/spotted-java/0.9.0)
...
The REST API documentation can be found on [spotted.stldocs.com](https://spotted.stldocs.com). Javadocs are available on [javadoc.io](https://javadoc.io/doc/dev.cjav.spotted/spotted-java/0.9.0).
...
```kotlin
implementation("dev.cjav.spotted:spotted-java:0.9.0")
```
