...
[![Maven Central](https://img.shields.io/maven-central/v/dev.cjav.spotted/spotted-java)](https://central.sonatype.com/artifact/dev.cjav.spotted/spotted-java/0.14.0)
[![javadoc](https://javadoc.io/badge2/dev.cjav.spotted/spotted-java/0.14.0/javadoc.svg)](https://javadoc.io/doc/dev.cjav.spotted/spotted-java/0.14.0)

<!-- x-release-please-end -->

The Unofficial Spotify SDK provides convenient access to the [Spotted REST API](https://spotted.stldocs.com?docs) from applications written in Java.
...
The REST API documentation can be found on [spotted.stldocs.com](https://spotted.stldocs.com?docs). Javadocs are available on [javadoc.io](https://javadoc.io/doc/dev.cjav.spotted/spotted-java/0.14.0).
...
```kotlin
implementation("dev.cjav.spotted:spotted-java:0.14.0")
```
