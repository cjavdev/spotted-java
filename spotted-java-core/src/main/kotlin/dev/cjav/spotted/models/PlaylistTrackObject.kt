...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun addedBy(): Optional<PlaylistUserObject> = addedBy.getOptional("added_by")
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = track.accept(new Track.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitTrack(TrackObject track) {
         *         return Optional.of(track.toString());
         *     }
        ...
        companion object {
            ...
            @JvmStatic fun ofTrack(track: TrackObject) = Track(track = track)

            @JvmStatic fun ofEpisode(episode: EpisodeObject) = Track(episode = episode)
        }
