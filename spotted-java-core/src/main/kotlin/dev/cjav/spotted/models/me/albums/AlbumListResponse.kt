...
private constructor(
    ...
    ) : this(addedAt, album, published, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(albumListResponse: AlbumListResponse) = apply {
            ...
            published = albumListResponse.published
        ...
        fun build(): AlbumListResponse =
            AlbumListResponse(addedAt, album, published, additionalProperties.toMutableMap())
    }
    ...
    internal fun validity(): Int =
        (if (addedAt.asKnown().isPresent) 1 else 0) +
            (album.asKnown().getOrNull()?.validity() ?: 0) +
    ...
    private val hashCode: Int by lazy {
        Objects.hash(addedAt, album, published, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "AlbumListResponse{addedAt=$addedAt, album=$album, published=$published, additionalProperties=$additionalProperties}"
}
