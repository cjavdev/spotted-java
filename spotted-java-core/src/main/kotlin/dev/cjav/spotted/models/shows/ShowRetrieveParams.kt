...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ShowRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ShowRetrieveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ShowRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(showRetrieveParams: ShowRetrieveParams) = apply {
            id = showRetrieveParams.id
            market = showRetrieveParams.market
            additionalHeaders = showRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = showRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ShowRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ShowRetrieveParams =
            ShowRetrieveParams(id, market, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ShowRetrieveParams &&
            id == other.id &&
            market == other.market &&
    ...
    override fun toString() =
        "ShowRetrieveParams{id=$id, market=$market, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
