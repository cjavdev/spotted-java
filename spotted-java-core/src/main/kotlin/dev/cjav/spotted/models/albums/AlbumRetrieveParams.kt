...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AlbumRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AlbumRetrieveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AlbumRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(albumRetrieveParams: AlbumRetrieveParams) = apply {
            id = albumRetrieveParams.id
            market = albumRetrieveParams.market
            additionalHeaders = albumRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = albumRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AlbumRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AlbumRetrieveParams =
            AlbumRetrieveParams(
                id,
                market,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AlbumRetrieveParams &&
            id == other.id &&
            market == other.market &&
    ...
    override fun toString() =
        "AlbumRetrieveParams{id=$id, market=$market, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
