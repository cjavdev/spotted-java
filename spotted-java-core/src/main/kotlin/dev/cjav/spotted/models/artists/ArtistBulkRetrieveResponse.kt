...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ArtistBulkRetrieveResponse].
         *
    ...
    /** A builder for [ArtistBulkRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(artistBulkRetrieveResponse: ArtistBulkRetrieveResponse) = apply {
            artists = artistBulkRetrieveResponse.artists.map { it.toMutableList() }
            additionalProperties = artistBulkRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ArtistBulkRetrieveResponse].
         *
         ...
         */
        fun build(): ArtistBulkRetrieveResponse =
    ...
    fun validate(): ArtistBulkRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ArtistBulkRetrieveResponse &&
    ...
    override fun toString() =
        "ArtistBulkRetrieveResponse{artists=$artists, additionalProperties=$additionalProperties}"
}
