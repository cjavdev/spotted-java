...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EpisodeRemoveParams = builder().build()
    ...
    override fun toString() =
        "EpisodeRemoveParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
