...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ShowBulkRetrieveParams].
         *
    ...
    /** A builder for [ShowBulkRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(showBulkRetrieveParams: ShowBulkRetrieveParams) = apply {
            ids = showBulkRetrieveParams.ids
            market = showBulkRetrieveParams.market
            additionalHeaders = showBulkRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = showBulkRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ShowBulkRetrieveParams].
         *
         ...
         */
        fun build(): ShowBulkRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ShowBulkRetrieveParams &&
            ids == other.ids &&
            market == other.market &&
    ...
    override fun toString() =
        "ShowBulkRetrieveParams{ids=$ids, market=$market, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
