...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [NarratorObject]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [NarratorObject]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [NarratorObject].
         *
    ...
    fun validate(): NarratorObject = apply {
        if (validated) {
            return@apply
        }
