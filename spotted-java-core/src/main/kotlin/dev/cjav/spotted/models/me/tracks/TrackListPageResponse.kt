...
private constructor(
    ...
    private val items: JsonField<List<TrackListResponse>>,
    ...
    private constructor(
        ...
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<TrackListResponse>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun items(): Optional<List<TrackListResponse>> = items.getOptional("items")
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<TrackListResponse>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TrackListPageResponse].
         *
    ...
    /** A builder for [TrackListPageResponse]. */
    class Builder internal constructor() {
        ...
        private var items: JsonField<MutableList<TrackListResponse>>? = null
        private var published: JsonField<Boolean> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(trackListPageResponse: TrackListPageResponse) = apply {
            href = trackListPageResponse.href
            limit = trackListPageResponse.limit
            next = trackListPageResponse.next
            offset = trackListPageResponse.offset
            previous = trackListPageResponse.previous
            total = trackListPageResponse.total
            items = trackListPageResponse.items.map { it.toMutableList() }
            published = trackListPageResponse.published
            additionalProperties = trackListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        fun items(items: List<TrackListResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<TrackListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<TrackListResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [TrackListResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: TrackListResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [TrackListPageResponse].
         *
         ...
         */
        fun build(): TrackListPageResponse =
            TrackListPageResponse(
    ...
    fun validate(): TrackListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TrackListPageResponse &&
            href == other.href &&
            limit == other.limit &&
            next == other.next &&
            offset == other.offset &&
    ...
    override fun toString() =
        "TrackListPageResponse{href=$href, limit=$limit, next=$next, offset=$offset, previous=$previous, total=$total, items=$items, published=$published, additionalProperties=$additionalProperties}"
}
