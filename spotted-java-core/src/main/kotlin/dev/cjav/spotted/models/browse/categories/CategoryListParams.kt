...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CategoryListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CategoryListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CategoryListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(categoryListParams: CategoryListParams) = apply {
            limit = categoryListParams.limit
            locale = categoryListParams.locale
            offset = categoryListParams.offset
            additionalHeaders = categoryListParams.additionalHeaders.toBuilder()
            additionalQueryParams = categoryListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CategoryListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CategoryListParams =
            CategoryListParams(
                limit,
                locale,
                offset,
    ...
    override fun toString() =
        "CategoryListParams{limit=$limit, locale=$locale, offset=$offset, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
