...
class AudiobookListChaptersPageResponse
...
private constructor(
    ...
    /** A builder for [AudiobookListChaptersPageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(audiobookListChaptersPageResponse: AudiobookListChaptersPageResponse) =
            apply {
                href = audiobookListChaptersPageResponse.href
                limit = audiobookListChaptersPageResponse.limit
                next = audiobookListChaptersPageResponse.next
                offset = audiobookListChaptersPageResponse.offset
                previous = audiobookListChaptersPageResponse.previous
                total = audiobookListChaptersPageResponse.total
                items = audiobookListChaptersPageResponse.items.map { it.toMutableList() }
                published = audiobookListChaptersPageResponse.published
                additionalProperties =
                    audiobookListChaptersPageResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.items] with a well-typed `List<SimplifiedChapterObject>`
        ...
        /**
         * Returns an immutable instance of [AudiobookListChaptersPageResponse].
         *
         ...
         */
        fun build(): AudiobookListChaptersPageResponse =
            AudiobookListChaptersPageResponse(
    ...
    fun validate(): AudiobookListChaptersPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AudiobookListChaptersPageResponse &&
            href == other.href &&
            limit == other.limit &&
            next == other.next &&
            offset == other.offset &&
    ...
    override fun toString() =
        "AudiobookListChaptersPageResponse{href=$href, limit=$limit, next=$next, offset=$offset, previous=$previous, total=$total, items=$items, published=$published, additionalProperties=$additionalProperties}"
}
