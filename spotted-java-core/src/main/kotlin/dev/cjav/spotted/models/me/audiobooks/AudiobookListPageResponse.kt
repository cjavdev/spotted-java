...
class AudiobookListPageResponse
...
private constructor(
    ...
    private val items: JsonField<List<AudiobookListResponse>>,
    ...
    private constructor(
        ...
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<AudiobookListResponse>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun items(): Optional<List<AudiobookListResponse>> = items.getOptional("items")
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<AudiobookListResponse>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AudiobookListPageResponse].
         *
    ...
    /** A builder for [AudiobookListPageResponse]. */
    class Builder internal constructor() {
        ...
        private var items: JsonField<MutableList<AudiobookListResponse>>? = null
        private var published: JsonField<Boolean> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(audiobookListPageResponse: AudiobookListPageResponse) = apply {
            href = audiobookListPageResponse.href
            limit = audiobookListPageResponse.limit
            next = audiobookListPageResponse.next
            offset = audiobookListPageResponse.offset
            previous = audiobookListPageResponse.previous
            total = audiobookListPageResponse.total
            items = audiobookListPageResponse.items.map { it.toMutableList() }
            published = audiobookListPageResponse.published
            additionalProperties = audiobookListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        fun items(items: List<AudiobookListResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<AudiobookListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun items(items: JsonField<List<AudiobookListResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [AudiobookListResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: AudiobookListResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [AudiobookListPageResponse].
         *
         ...
         */
        fun build(): AudiobookListPageResponse =
            AudiobookListPageResponse(
    ...
    fun validate(): AudiobookListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AudiobookListPageResponse &&
            href == other.href &&
            limit == other.limit &&
            next == other.next &&
            offset == other.offset &&
    ...
    override fun toString() =
        "AudiobookListPageResponse{href=$href, limit=$limit, next=$next, offset=$offset, previous=$previous, total=$total, items=$items, published=$published, additionalProperties=$additionalProperties}"
}
