 ...
 */
class AudiobookListChaptersParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AudiobookListChaptersParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [AudiobookListChaptersParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AudiobookListChaptersParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(audiobookListChaptersParams: AudiobookListChaptersParams) = apply {
            id = audiobookListChaptersParams.id
            limit = audiobookListChaptersParams.limit
            market = audiobookListChaptersParams.market
            offset = audiobookListChaptersParams.offset
            additionalHeaders = audiobookListChaptersParams.additionalHeaders.toBuilder()
            additionalQueryParams = audiobookListChaptersParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AudiobookListChaptersParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AudiobookListChaptersParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AudiobookListChaptersParams &&
            id == other.id &&
            limit == other.limit &&
            market == other.market &&
            offset == other.offset &&
    ...
    override fun toString() =
        "AudiobookListChaptersParams{id=$id, limit=$limit, market=$market, offset=$offset, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
