...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [EpisodeRestrictionObject]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [EpisodeRestrictionObject]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(episodeRestrictionObject: EpisodeRestrictionObject) = apply {
            published = episodeRestrictionObject.published
            reason = episodeRestrictionObject.reason
            additionalProperties = episodeRestrictionObject.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EpisodeRestrictionObject].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EpisodeRestrictionObject =
            EpisodeRestrictionObject(published, reason, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): EpisodeRestrictionObject = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EpisodeRestrictionObject &&
    ...
    override fun toString() =
        "EpisodeRestrictionObject{published=$published, reason=$reason, additionalProperties=$additionalProperties}"
}
