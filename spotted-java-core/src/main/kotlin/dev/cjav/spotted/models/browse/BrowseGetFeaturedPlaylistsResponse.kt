...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(browseGetFeaturedPlaylistsResponse: BrowseGetFeaturedPlaylistsResponse) =
            apply {
                ...
                published = browseGetFeaturedPlaylistsResponse.published
    ...
    override fun toString() =
        "BrowseGetFeaturedPlaylistsResponse{message=$message, playlists=$playlists, published=$published, additionalProperties=$additionalProperties}"
}
