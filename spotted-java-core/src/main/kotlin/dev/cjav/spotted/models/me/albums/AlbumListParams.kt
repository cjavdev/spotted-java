...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AlbumListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(albumListParams: AlbumListParams) = apply {
            limit = albumListParams.limit
            market = albumListParams.market
            offset = albumListParams.offset
    ...
    override fun toString() =
        "AlbumListParams{limit=$limit, market=$market, offset=$offset, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
