...
private constructor(
     ...
     */
    fun albums(): Albums = albums.getRequired("albums")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrowseGetNewReleasesResponse].
         *
    ...
    /** A builder for [BrowseGetNewReleasesResponse]. */
    class Builder internal constructor() {

        private var albums: JsonField<Albums>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(browseGetNewReleasesResponse: BrowseGetNewReleasesResponse) = apply {
            albums = browseGetNewReleasesResponse.albums
            additionalProperties = browseGetNewReleasesResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowseGetNewReleasesResponse].
         *
         ...
         */
        fun build(): BrowseGetNewReleasesResponse =
            BrowseGetNewReleasesResponse(
                checkRequired("albums", albums),
     ...
     *   expected type.
     */
    fun validate(): BrowseGetNewReleasesResponse = apply {
        if (validated) {
            return@apply
        }
     ...
     */
    @JvmSynthetic internal fun validity(): Int = (albums.asKnown().getOrNull()?.validity() ?: 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowseGetNewReleasesResponse &&
            albums == other.albums &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "BrowseGetNewReleasesResponse{albums=$albums, additionalProperties=$additionalProperties}"
}
