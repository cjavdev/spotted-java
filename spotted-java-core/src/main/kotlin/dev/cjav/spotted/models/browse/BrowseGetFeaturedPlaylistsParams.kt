...
class BrowseGetFeaturedPlaylistsParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BrowseGetFeaturedPlaylistsParams = builder().build()
    ...
    /** A builder for [BrowseGetFeaturedPlaylistsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browseGetFeaturedPlaylistsParams: BrowseGetFeaturedPlaylistsParams) =
            apply {
                limit = browseGetFeaturedPlaylistsParams.limit
                locale = browseGetFeaturedPlaylistsParams.locale
                offset = browseGetFeaturedPlaylistsParams.offset
                additionalHeaders = browseGetFeaturedPlaylistsParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    browseGetFeaturedPlaylistsParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [BrowseGetFeaturedPlaylistsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowseGetFeaturedPlaylistsParams =
            BrowseGetFeaturedPlaylistsParams(
                limit,
                locale,
                offset,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowseGetFeaturedPlaylistsParams &&
            limit == other.limit &&
            locale == other.locale &&
            offset == other.offset &&
    ...
    override fun hashCode(): Int =
        Objects.hash(limit, locale, offset, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "BrowseGetFeaturedPlaylistsParams{limit=$limit, locale=$locale, offset=$offset, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
