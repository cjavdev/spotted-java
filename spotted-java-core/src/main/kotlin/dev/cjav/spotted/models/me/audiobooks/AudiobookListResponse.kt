...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AudiobookListResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AudiobookListResponse]. */
    class Builder internal constructor() {
        ...
        /** Information about the audiobook. */
        fun audiobook(audiobook: Audiobook) = audiobook(JsonField.of(audiobook))

        /**
         * Sets [Builder.audiobook] to an arbitrary JSON value.
         *
         * You should usually call [Builder.audiobook] with a well-typed [Audiobook] value instead.
        ...
        /**
         * Returns an immutable instance of [AudiobookListResponse].
         *
    ...
    fun validate(): AudiobookListResponse = apply {
        if (validated) {
            return@apply
        }
