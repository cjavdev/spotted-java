...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [TrackAddResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TrackAddResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackAddResponse: TrackAddResponse) = apply {
            snapshotId = trackAddResponse.snapshotId
            additionalProperties = trackAddResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TrackAddResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TrackAddResponse =
            TrackAddResponse(snapshotId, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): TrackAddResponse = apply {
        if (validated) {
            return@apply
        }
     ...
     */
    @JvmSynthetic internal fun validity(): Int = (if (snapshotId.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TrackAddResponse &&
    ...
    override fun toString() =
        "TrackAddResponse{snapshotId=$snapshotId, additionalProperties=$additionalProperties}"
}
