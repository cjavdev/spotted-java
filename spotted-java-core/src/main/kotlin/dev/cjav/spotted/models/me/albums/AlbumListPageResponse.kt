...
private constructor(
    ...
    private val items: JsonField<List<AlbumListResponse>>,
    ...
    private constructor(
        ...
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<AlbumListResponse>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun items(): Optional<List<AlbumListResponse>> = items.getOptional("items")
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<AlbumListResponse>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AlbumListPageResponse].
         *
    ...
    /** A builder for [AlbumListPageResponse]. */
    class Builder internal constructor() {
        ...
        private var items: JsonField<MutableList<AlbumListResponse>>? = null
        private var published: JsonField<Boolean> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(albumListPageResponse: AlbumListPageResponse) = apply {
            href = albumListPageResponse.href
            limit = albumListPageResponse.limit
            next = albumListPageResponse.next
            offset = albumListPageResponse.offset
            previous = albumListPageResponse.previous
            total = albumListPageResponse.total
            items = albumListPageResponse.items.map { it.toMutableList() }
            published = albumListPageResponse.published
            additionalProperties = albumListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        fun items(items: List<AlbumListResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<AlbumListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<AlbumListResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [AlbumListResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: AlbumListResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [AlbumListPageResponse].
         *
         ...
         */
        fun build(): AlbumListPageResponse =
            AlbumListPageResponse(
    ...
    fun validate(): AlbumListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AlbumListPageResponse &&
            href == other.href &&
            limit == other.limit &&
            next == other.next &&
            offset == other.offset &&
    ...
    override fun toString() =
        "AlbumListPageResponse{href=$href, limit=$limit, next=$next, offset=$offset, previous=$previous, total=$total, items=$items, published=$published, additionalProperties=$additionalProperties}"
}
