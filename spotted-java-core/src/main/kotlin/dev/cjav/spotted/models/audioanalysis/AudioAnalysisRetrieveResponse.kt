...
private constructor(
     ...
     */
    fun bars(): Optional<List<TimeIntervalObject>> = bars.getOptional("bars")
     ...
     *   server responded with an unexpected value).
     */
    fun beats(): Optional<List<TimeIntervalObject>> = beats.getOptional("beats")
     ...
     *   server responded with an unexpected value).
     */
    fun tatums(): Optional<List<TimeIntervalObject>> = tatums.getOptional("tatums")
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun analysisTime(): Optional<Double> = analysisTime.getOptional("analysis_time")
         ...
         *   server responded with an unexpected value).
         */
        fun analyzerVersion(): Optional<String> = analyzerVersion.getOptional("analyzer_version")
         ...
         *   server responded with an unexpected value).
         */
        fun detailedStatus(): Optional<String> = detailedStatus.getOptional("detailed_status")
         ...
         *   server responded with an unexpected value).
         */
        fun inputProcess(): Optional<String> = inputProcess.getOptional("input_process")
        ...
        @JvmSynthetic
        internal fun validity(): Int =
            (if (analysisTime.asKnown().isPresent) 1 else 0) +
                (if (analyzerVersion.asKnown().isPresent) 1 else 0) +
                (if (detailedStatus.asKnown().isPresent) 1 else 0) +
                (if (inputProcess.asKnown().isPresent) 1 else 0) +
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun keyConfidence(): Optional<Double> = keyConfidence.getOptional("key_confidence")
         ...
         *   server responded with an unexpected value).
         */
        fun loudness(): Optional<Double> = loudness.getOptional("loudness")
         ...
         *   server responded with an unexpected value).
         */
        fun tempo(): Optional<Double> = tempo.getOptional("tempo")
         ...
         *   server responded with an unexpected value).
         */
        fun tempoConfidence(): Optional<Double> = tempoConfidence.getOptional("tempo_confidence")
         ...
         *   server responded with an unexpected value).
         */
        fun timeSignatureConfidence(): Optional<Double> =
            timeSignatureConfidence.getOptional("time_signature_confidence")
        ...
        internal fun validity(): Int =
            (if (confidence.asKnown().isPresent) 1 else 0) +
                ...
                (if (keyConfidence.asKnown().isPresent) 1 else 0) +
                ...
                (if (timeSignatureConfidence.asKnown().isPresent) 1 else 0)
        ...
        class Mode @JsonCreator private constructor(private val value: JsonField<Double>) : Enum {
            ...
            companion object {
                ...
                @JvmField val MODE_NO_RESULT = of(-1.0)

                @JvmField val MODE_MINOR = of(0.0)

                @JvmField val MODE_MAJOR = of(1.0)
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun loudnessEnd(): Optional<Double> = loudnessEnd.getOptional("loudness_end")
         ...
         *   server responded with an unexpected value).
         */
        fun loudnessMax(): Optional<Double> = loudnessMax.getOptional("loudness_max")
         ...
         *   server responded with an unexpected value).
         */
        fun loudnessMaxTime(): Optional<Double> = loudnessMaxTime.getOptional("loudness_max_time")
         ...
         *   server responded with an unexpected value).
         */
        fun loudnessStart(): Optional<Double> = loudnessStart.getOptional("loudness_start")
         ...
         *   server responded with an unexpected value).
         */
        fun timbre(): Optional<List<Double>> = timbre.getOptional("timbre")
        ...
        internal fun validity(): Int =
            (if (confidence.asKnown().isPresent) 1 else 0) +
                (if (duration.asKnown().isPresent) 1 else 0) +
                (if (loudnessEnd.asKnown().isPresent) 1 else 0) +
                (if (loudnessMax.asKnown().isPresent) 1 else 0) +
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun analysisChannels(): Optional<Long> = analysisChannels.getOptional("analysis_channels")
         ...
         *   server responded with an unexpected value).
         */
        fun analysisSampleRate(): Optional<Long> =
            analysisSampleRate.getOptional("analysis_sample_rate")
         ...
         *   server responded with an unexpected value).
         */
        fun codeVersion(): Optional<Double> = codeVersion.getOptional("code_version")
         ...
         *   server responded with an unexpected value).
         */
        fun codestring(): Optional<String> = codestring.getOptional("codestring")
         ...
         *   server responded with an unexpected value).
         */
        fun echoprintVersion(): Optional<Double> = echoprintVersion.getOptional("echoprint_version")
         ...
         *   server responded with an unexpected value).
         */
        fun echoprintstring(): Optional<String> = echoprintstring.getOptional("echoprintstring")
         ...
         *   server responded with an unexpected value).
         */
        fun endOfFadeIn(): Optional<Double> = endOfFadeIn.getOptional("end_of_fade_in")
         ...
         *   server responded with an unexpected value).
         */
        fun offsetSeconds(): Optional<Long> = offsetSeconds.getOptional("offset_seconds")
         ...
         *   server responded with an unexpected value).
         */
        fun rhythmVersion(): Optional<Double> = rhythmVersion.getOptional("rhythm_version")
         ...
         *   server responded with an unexpected value).
         */
        fun rhythmstring(): Optional<String> = rhythmstring.getOptional("rhythmstring")
         ...
         *   server responded with an unexpected value).
         */
        fun sampleMd5(): Optional<String> = sampleMd5.getOptional("sample_md5")
         ...
         *   server responded with an unexpected value).
         */
        fun startOfFadeOut(): Optional<Double> = startOfFadeOut.getOptional("start_of_fade_out")
         ...
         *   server responded with an unexpected value).
         */
        fun synchVersion(): Optional<Double> = synchVersion.getOptional("synch_version")
         ...
         *   server responded with an unexpected value).
         */
        fun synchstring(): Optional<String> = synchstring.getOptional("synchstring")
         ...
         *   server responded with an unexpected value).
         */
        fun windowSeconds(): Optional<Long> = windowSeconds.getOptional("window_seconds")
        ...
        @JvmSynthetic
        internal fun validity(): Int =
            (if (analysisChannels.asKnown().isPresent) 1 else 0) +
                (if (analysisSampleRate.asKnown().isPresent) 1 else 0) +
                (if (codeVersion.asKnown().isPresent) 1 else 0) +
                (if (codestring.asKnown().isPresent) 1 else 0) +
                (if (duration.asKnown().isPresent) 1 else 0) +
                (if (echoprintVersion.asKnown().isPresent) 1 else 0) +
                (if (echoprintstring.asKnown().isPresent) 1 else 0) +
                (if (endOfFadeIn.asKnown().isPresent) 1 else 0) +
                (if (key.asKnown().isPresent) 1 else 0) +
                (if (keyConfidence.asKnown().isPresent) 1 else 0) +
                (if (loudness.asKnown().isPresent) 1 else 0) +
                ...
                (if (offsetSeconds.asKnown().isPresent) 1 else 0) +
                (if (rhythmVersion.asKnown().isPresent) 1 else 0) +
                (if (rhythmstring.asKnown().isPresent) 1 else 0) +
                (if (sampleMd5.asKnown().isPresent) 1 else 0) +
                (if (startOfFadeOut.asKnown().isPresent) 1 else 0) +
                (if (synchVersion.asKnown().isPresent) 1 else 0) +
                (if (synchstring.asKnown().isPresent) 1 else 0) +
                (if (tempo.asKnown().isPresent) 1 else 0) +
                (if (tempoConfidence.asKnown().isPresent) 1 else 0) +
                (if (timeSignature.asKnown().isPresent) 1 else 0) +
                (if (timeSignatureConfidence.asKnown().isPresent) 1 else 0) +
                (if (windowSeconds.asKnown().isPresent) 1 else 0)
