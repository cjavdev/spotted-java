...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EpisodeRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [EpisodeRetrieveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [EpisodeRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(episodeRetrieveParams: EpisodeRetrieveParams) = apply {
            id = episodeRetrieveParams.id
            market = episodeRetrieveParams.market
            additionalHeaders = episodeRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = episodeRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EpisodeRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EpisodeRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EpisodeRetrieveParams &&
            id == other.id &&
            market == other.market &&
    ...
    override fun toString() =
        "EpisodeRetrieveParams{id=$id, market=$market, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
