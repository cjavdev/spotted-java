...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(playlistCreateResponse: PlaylistCreateResponse) = apply {
            ...
            componentsSchemasPropertiesIsPublic =
                playlistCreateResponse.componentsSchemasPropertiesIsPublic
    ...
    override fun toString() =
        "PlaylistCreateResponse{id=$id, componentsSchemasPropertiesIsPublic=$componentsSchemasPropertiesIsPublic, collaborative=$collaborative, description=$description, externalUrls=$externalUrls, followers=$followers, href=$href, images=$images, name=$name, owner=$owner, snapshotId=$snapshotId, tracks=$tracks, type=$type, uri=$uri, additionalProperties=$additionalProperties}"
}
