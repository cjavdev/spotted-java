...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TrackBulkRetrieveParams].
         *
    ...
    /** A builder for [TrackBulkRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackBulkRetrieveParams: TrackBulkRetrieveParams) = apply {
            ids = trackBulkRetrieveParams.ids
            market = trackBulkRetrieveParams.market
            additionalHeaders = trackBulkRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = trackBulkRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TrackBulkRetrieveParams].
         *
         ...
         */
        fun build(): TrackBulkRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TrackBulkRetrieveParams &&
            ids == other.ids &&
            market == other.market &&
    ...
    override fun toString() =
        "TrackBulkRetrieveParams{ids=$ids, market=$market, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
