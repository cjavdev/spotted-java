...
class CategoryGetPlaylistsResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CategoryGetPlaylistsResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CategoryGetPlaylistsResponse]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [CategoryGetPlaylistsResponse].
         *
    ...
    fun validate(): CategoryGetPlaylistsResponse = apply {
        if (validated) {
            return@apply
        }
