...
private constructor(
     ...
     */
    fun additionalTypes(): Optional<String> = Optional.ofNullable(additionalTypes)

    /**
     * Filters for the query: a comma-separated list of the fields to return. If omitted, all fields
     * are returned. For example, to get just the playlist''s description and URI:
     * `fields=description,uri`. A dot separator can be used to specify non-reoccurring fields,
     * while parentheses can be used to specify reoccurring fields within objects. For example, to
     ...
     * nested objects, for example: `fields=tracks.items(track(name,href,album(name,href)))`. Fields
     * can be excluded by prefixing them with an exclamation mark, for example:
     * `fields=tracks.items(track(name,href,album(!name,href)))`
     */
    fun fields(): Optional<String> = Optional.ofNullable(fields)
    ...
    companion object {
        ...
        @JvmStatic fun none(): PlaylistRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PlaylistRetrieveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PlaylistRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(playlistRetrieveParams: PlaylistRetrieveParams) = apply {
            playlistId = playlistRetrieveParams.playlistId
            additionalTypes = playlistRetrieveParams.additionalTypes
            fields = playlistRetrieveParams.fields
            market = playlistRetrieveParams.market
            additionalHeaders = playlistRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = playlistRetrieveParams.additionalQueryParams.toBuilder()
        }

        /** The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) of the playlist. */
        fun playlistId(playlistId: String?) = apply { this.playlistId = playlistId }

        /** Alias for calling [Builder.playlistId] with `playlistId.orElse(null)`. */
        ...
        /** Alias for calling [Builder.additionalTypes] with `additionalTypes.orElse(null)`. */
        fun additionalTypes(additionalTypes: Optional<String>) =
            additionalTypes(additionalTypes.getOrNull())

        /**
         * Filters for the query: a comma-separated list of the fields to return. If omitted, all
         * fields are returned. For example, to get just the playlist''s description and URI:
         * `fields=description,uri`. A dot separator can be used to specify non-reoccurring fields,
         * while parentheses can be used to specify reoccurring fields within objects. For example,
         * to get just the added date and user ID of the adder:
         * `fields=tracks.items(added_at,added_by.id)`. Use multiple parentheses to drill down into
        ...
        fun fields(fields: Optional<String>) = fields(fields.getOrNull())
        ...
        /**
         * Returns an immutable instance of [PlaylistRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PlaylistRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PlaylistRetrieveParams &&
    ...
    override fun toString() =
        "PlaylistRetrieveParams{playlistId=$playlistId, additionalTypes=$additionalTypes, fields=$fields, market=$market, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
