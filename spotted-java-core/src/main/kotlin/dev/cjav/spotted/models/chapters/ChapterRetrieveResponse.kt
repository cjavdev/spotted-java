...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ChapterRetrieveResponse].
         *
    ...
    /** A builder for [ChapterRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(chapterRetrieveResponse: ChapterRetrieveResponse) = apply {
            id = chapterRetrieveResponse.id
            audioPreviewUrl = chapterRetrieveResponse.audioPreviewUrl
            audiobook = chapterRetrieveResponse.audiobook
            chapterNumber = chapterRetrieveResponse.chapterNumber
            description = chapterRetrieveResponse.description
            durationMs = chapterRetrieveResponse.durationMs
            explicit = chapterRetrieveResponse.explicit
            externalUrls = chapterRetrieveResponse.externalUrls
            href = chapterRetrieveResponse.href
            htmlDescription = chapterRetrieveResponse.htmlDescription
            images = chapterRetrieveResponse.images.map { it.toMutableList() }
            isPlayable = chapterRetrieveResponse.isPlayable
            languages = chapterRetrieveResponse.languages.map { it.toMutableList() }
            name = chapterRetrieveResponse.name
            releaseDate = chapterRetrieveResponse.releaseDate
            releaseDatePrecision = chapterRetrieveResponse.releaseDatePrecision
            type = chapterRetrieveResponse.type
            uri = chapterRetrieveResponse.uri
            availableMarkets = chapterRetrieveResponse.availableMarkets.map { it.toMutableList() }
            published = chapterRetrieveResponse.published
            restrictions = chapterRetrieveResponse.restrictions
            resumePoint = chapterRetrieveResponse.resumePoint
            additionalProperties = chapterRetrieveResponse.additionalProperties.toMutableMap()
        }
         ...
         * supported value.
         */
        fun audiobook(audiobook: JsonField<AudiobookBase>) = apply { this.audiobook = audiobook }
        ...
        /**
         * Returns an immutable instance of [ChapterRetrieveResponse].
         *
         ...
         */
        fun build(): ChapterRetrieveResponse =
    ...
    fun validate(): ChapterRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(private val value: JsonField<String>) : Enum {
         ...
         */
        fun asString(): String =
            _value().asString().orElseThrow { SpottedInvalidDataException("Value is not a String") }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChapterRetrieveResponse &&
            id == other.id &&
