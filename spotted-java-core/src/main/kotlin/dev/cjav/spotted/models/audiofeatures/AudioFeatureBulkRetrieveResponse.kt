...
class AudioFeatureBulkRetrieveResponse
...
private constructor(
    ...
    /** A builder for [AudioFeatureBulkRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(audioFeatureBulkRetrieveResponse: AudioFeatureBulkRetrieveResponse) =
            apply {
                audioFeatures =
                    audioFeatureBulkRetrieveResponse.audioFeatures.map { it.toMutableList() }
                additionalProperties =
                    audioFeatureBulkRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AudioFeatureBulkRetrieveResponse].
         *
         ...
         */
        fun build(): AudioFeatureBulkRetrieveResponse =
            AudioFeatureBulkRetrieveResponse(
    ...
    fun validate(): AudioFeatureBulkRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(audioFeature: AudioFeature) = apply {
                ...
                published = audioFeature.published
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AudioFeatureBulkRetrieveResponse &&
    ...
    override fun toString() =
        "AudioFeatureBulkRetrieveResponse{audioFeatures=$audioFeatures, additionalProperties=$additionalProperties}"
}
