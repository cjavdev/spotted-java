...
/**
 * Get Spotify catalog information about an album’s tracks. Optional parameters can be used to limit
 * the number of tracks returned.
 */
class AlbumListTracksParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AlbumListTracksParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AlbumListTracksParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AlbumListTracksParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(albumListTracksParams: AlbumListTracksParams) = apply {
            id = albumListTracksParams.id
            limit = albumListTracksParams.limit
            market = albumListTracksParams.market
            offset = albumListTracksParams.offset
            additionalHeaders = albumListTracksParams.additionalHeaders.toBuilder()
            additionalQueryParams = albumListTracksParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AlbumListTracksParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AlbumListTracksParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AlbumListTracksParams &&
            id == other.id &&
            limit == other.limit &&
            market == other.market &&
            offset == other.offset &&
    ...
    override fun toString() =
        "AlbumListTracksParams{id=$id, limit=$limit, market=$market, offset=$offset, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
