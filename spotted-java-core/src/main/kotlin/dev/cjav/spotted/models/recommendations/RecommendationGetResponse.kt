...
private constructor(
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun afterFilteringSize(): Optional<Long> =
            afterFilteringSize.getOptional("afterFilteringSize")
         ...
         *   server responded with an unexpected value).
         */
        fun afterRelinkingSize(): Optional<Long> =
            afterRelinkingSize.getOptional("afterRelinkingSize")
        ...
        internal fun validity(): Int =
            (if (id.asKnown().isPresent) 1 else 0) +
                (if (afterFilteringSize.asKnown().isPresent) 1 else 0) +
