...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AlbumRemoveParams = builder().build()
    ...
    override fun toString() =
        "AlbumRemoveParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
