...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun timestampedIds(): Optional<List<TimestampedId>> = body.timestampedIds()
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun timestampedIds(): Optional<List<TimestampedId>> =
            timestampedIds.getOptional("timestamped_ids")
    ...
    private constructor(
        ...
        @JvmSynthetic
        internal fun validity(): Int =
            (if (id.asKnown().isPresent) 1 else 0) + (if (addedAt.asKnown().isPresent) 1 else 0)
