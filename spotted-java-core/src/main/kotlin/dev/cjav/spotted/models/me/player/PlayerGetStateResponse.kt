...
private constructor(
     ...
     */
    fun actions(): Optional<Actions> = actions.getOptional("actions")
     ...
     *   server responded with an unexpected value).
     */
    fun context(): Optional<ContextObject> = context.getOptional("context")
     ...
     *   server responded with an unexpected value).
     */
    fun currentlyPlayingType(): Optional<String> =
        currentlyPlayingType.getOptional("currently_playing_type")
     ...
     *   server responded with an unexpected value).
     */
    fun device(): Optional<DeviceObject> = device.getOptional("device")
     ...
     *   server responded with an unexpected value).
     */
    fun isPlaying(): Optional<Boolean> = isPlaying.getOptional("is_playing")
     ...
     *   server responded with an unexpected value).
     */
    fun repeatState(): Optional<String> = repeatState.getOptional("repeat_state")
     ...
     *   server responded with an unexpected value).
     */
    fun shuffleState(): Optional<Boolean> = shuffleState.getOptional("shuffle_state")
    ...
    class Builder internal constructor() {
        ...
        internal fun from(playerGetStateResponse: PlayerGetStateResponse) = apply {
            ...
            published = playerGetStateResponse.published
    ...
    internal fun validity(): Int =
        (actions.asKnown().getOrNull()?.validity() ?: 0) +
            ...
            (if (currentlyPlayingType.asKnown().isPresent) 1 else 0) +
            ...
            (if (repeatState.asKnown().isPresent) 1 else 0) +
            (if (shuffleState.asKnown().isPresent) 1 else 0) +
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun interruptingPlayback(): Optional<Boolean> =
            interruptingPlayback.getOptional("interrupting_playback")
         ...
         *   server responded with an unexpected value).
         */
        fun resuming(): Optional<Boolean> = resuming.getOptional("resuming")
         ...
         *   server responded with an unexpected value).
         */
        fun seeking(): Optional<Boolean> = seeking.getOptional("seeking")
         ...
         *   server responded with an unexpected value).
         */
        fun skippingNext(): Optional<Boolean> = skippingNext.getOptional("skipping_next")
         ...
         *   server responded with an unexpected value).
         */
        fun skippingPrev(): Optional<Boolean> = skippingPrev.getOptional("skipping_prev")
         ...
         *   server responded with an unexpected value).
         */
        fun togglingRepeatContext(): Optional<Boolean> =
            togglingRepeatContext.getOptional("toggling_repeat_context")
         ...
         *   server responded with an unexpected value).
         */
        fun togglingRepeatTrack(): Optional<Boolean> =
            togglingRepeatTrack.getOptional("toggling_repeat_track")
         ...
         *   server responded with an unexpected value).
         */
        fun togglingShuffle(): Optional<Boolean> = togglingShuffle.getOptional("toggling_shuffle")
         ...
         *   server responded with an unexpected value).
         */
        fun transferringPlayback(): Optional<Boolean> =
            transferringPlayback.getOptional("transferring_playback")
        ...
        internal fun validity(): Int =
            (if (interruptingPlayback.asKnown().isPresent) 1 else 0) +
                ...
                (if (skippingPrev.asKnown().isPresent) 1 else 0) +
                (if (togglingRepeatContext.asKnown().isPresent) 1 else 0) +
                (if (togglingRepeatTrack.asKnown().isPresent) 1 else 0) +
                (if (togglingShuffle.asKnown().isPresent) 1 else 0) +
                (if (transferringPlayback.asKnown().isPresent) 1 else 0)
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitTrack(TrackObject track) {
         *         return Optional.of(track.toString());
         *     }
         *
         *     // ...
         *
         ...
         * ```
         *
         * @throws SpottedInvalidDataException if [Visitor.unknown] is not overridden in [visitor]
    ...
    override fun toString() =
        "PlayerGetStateResponse{actions=$actions, context=$context, currentlyPlayingType=$currentlyPlayingType, device=$device, isPlaying=$isPlaying, item=$item, progressMs=$progressMs, published=$published, repeatState=$repeatState, shuffleState=$shuffleState, timestamp=$timestamp, additionalProperties=$additionalProperties}"
}
