...
class ShowListEpisodesPageResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ShowListEpisodesPageResponse].
         *
    ...
    /** A builder for [ShowListEpisodesPageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(showListEpisodesPageResponse: ShowListEpisodesPageResponse) = apply {
            href = showListEpisodesPageResponse.href
            limit = showListEpisodesPageResponse.limit
            next = showListEpisodesPageResponse.next
            offset = showListEpisodesPageResponse.offset
            previous = showListEpisodesPageResponse.previous
            total = showListEpisodesPageResponse.total
            items = showListEpisodesPageResponse.items.map { it.toMutableList() }
            published = showListEpisodesPageResponse.published
            additionalProperties = showListEpisodesPageResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.items] with a well-typed `List<SimplifiedEpisodeObject>`
        ...
        /**
         * Returns an immutable instance of [ShowListEpisodesPageResponse].
         *
         ...
         */
        fun build(): ShowListEpisodesPageResponse =
            ShowListEpisodesPageResponse(
    ...
    fun validate(): ShowListEpisodesPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ShowListEpisodesPageResponse &&
            href == other.href &&
            limit == other.limit &&
            next == other.next &&
            offset == other.offset &&
    ...
    override fun toString() =
        "ShowListEpisodesPageResponse{href=$href, limit=$limit, next=$next, offset=$offset, previous=$previous, total=$total, items=$items, published=$published, additionalProperties=$additionalProperties}"
}
