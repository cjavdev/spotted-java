...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ChapterBulkRetrieveParams].
         *
    ...
    /** A builder for [ChapterBulkRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(chapterBulkRetrieveParams: ChapterBulkRetrieveParams) = apply {
            ids = chapterBulkRetrieveParams.ids
            market = chapterBulkRetrieveParams.market
            additionalHeaders = chapterBulkRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = chapterBulkRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ChapterBulkRetrieveParams].
         *
         ...
         */
        fun build(): ChapterBulkRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChapterBulkRetrieveParams &&
            ids == other.ids &&
            market == other.market &&
    ...
    override fun toString() =
        "ChapterBulkRetrieveParams{ids=$ids, market=$market, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
