...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(categoryListResponse: CategoryListResponse) = apply {
            id = categoryListResponse.id
            href = categoryListResponse.href
            icons = categoryListResponse.icons.map { it.toMutableList() }
            name = categoryListResponse.name
            published = categoryListResponse.published
    ...
    override fun toString() =
        "CategoryListResponse{id=$id, href=$href, icons=$icons, name=$name, published=$published, additionalProperties=$additionalProperties}"
}
