...
private constructor(
    ...
    private val items: JsonField<List<ShowListResponse>>,
    ...
    private constructor(
        ...
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<ShowListResponse>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun items(): Optional<List<ShowListResponse>> = items.getOptional("items")
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<ShowListResponse>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ShowListPageResponse].
         *
    ...
    /** A builder for [ShowListPageResponse]. */
    class Builder internal constructor() {
        ...
        private var items: JsonField<MutableList<ShowListResponse>>? = null
        private var published: JsonField<Boolean> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(showListPageResponse: ShowListPageResponse) = apply {
            href = showListPageResponse.href
            limit = showListPageResponse.limit
            next = showListPageResponse.next
            offset = showListPageResponse.offset
            previous = showListPageResponse.previous
            total = showListPageResponse.total
            items = showListPageResponse.items.map { it.toMutableList() }
            published = showListPageResponse.published
            additionalProperties = showListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        fun items(items: List<ShowListResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<ShowListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<ShowListResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [ShowListResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: ShowListResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [ShowListPageResponse].
         *
         ...
         */
        fun build(): ShowListPageResponse =
            ShowListPageResponse(
    ...
    fun validate(): ShowListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ShowListPageResponse &&
            href == other.href &&
            limit == other.limit &&
            next == other.next &&
            offset == other.offset &&
    ...
    override fun toString() =
        "ShowListPageResponse{href=$href, limit=$limit, next=$next, offset=$offset, previous=$previous, total=$total, items=$items, published=$published, additionalProperties=$additionalProperties}"
}
