...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun items(): Optional<List<SimplifiedPlaylistObject>> = items.getOptional("items")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PagingPlaylistObject].
         *
    ...
    /** A builder for [PagingPlaylistObject]. */
    class Builder internal constructor() {
        ...
        internal fun from(pagingPlaylistObject: PagingPlaylistObject) = apply {
            ...
            published = pagingPlaylistObject.published
        ...
        /**
         * Returns an immutable instance of [PagingPlaylistObject].
         *
    ...
    fun validate(): PagingPlaylistObject = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "PagingPlaylistObject{href=$href, limit=$limit, next=$next, offset=$offset, previous=$previous, total=$total, items=$items, published=$published, additionalProperties=$additionalProperties}"
}
