...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AudiobookRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AudiobookRetrieveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AudiobookRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(audiobookRetrieveParams: AudiobookRetrieveParams) = apply {
            id = audiobookRetrieveParams.id
            market = audiobookRetrieveParams.market
            additionalHeaders = audiobookRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = audiobookRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AudiobookRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AudiobookRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AudiobookRetrieveParams &&
            id == other.id &&
            market == other.market &&
    ...
    override fun toString() =
        "AudiobookRetrieveParams{id=$id, market=$market, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
