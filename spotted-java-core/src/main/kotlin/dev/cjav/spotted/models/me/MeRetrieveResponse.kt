...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    @Deprecated("deprecated") fun country(): Optional<String> = country.getOptional("country")
     ...
     *   server responded with an unexpected value).
     */
    @Deprecated("deprecated") fun email(): Optional<String> = email.getOptional("email")
    ...
    fun explicitContent(): Optional<ExplicitContent> =
        explicitContent.getOptional("explicit_content")
     ...
     *   server responded with an unexpected value).
     */
    @Deprecated("deprecated") fun product(): Optional<String> = product.getOptional("product")
    ...
    fun validate(): MeRetrieveResponse = apply {
        ...
        displayName()
        email()
        explicitContent().ifPresent { it.validate() }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (explicitContent.asKnown().getOrNull()?.validity() ?: 0) +
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun filterEnabled(): Optional<Boolean> = filterEnabled.getOptional("filter_enabled")
         ...
         *   server responded with an unexpected value).
         */
        fun filterLocked(): Optional<Boolean> = filterLocked.getOptional("filter_locked")
        ...
        @JvmSynthetic
        internal fun validity(): Int =
            (if (filterEnabled.asKnown().isPresent) 1 else 0) +
                (if (filterLocked.asKnown().isPresent) 1 else 0) +
                (if (published.asKnown().isPresent) 1 else 0)
