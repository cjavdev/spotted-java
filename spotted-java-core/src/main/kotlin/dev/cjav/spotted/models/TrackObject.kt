...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun discNumber(): Optional<Long> = discNumber.getOptional("disc_number")
     ...
     *   server responded with an unexpected value).
     */
    fun explicit(): Optional<Boolean> = explicit.getOptional("explicit")
     ...
     *   server responded with an unexpected value).
     */
    fun externalUrls(): Optional<ExternalUrlObject> = externalUrls.getOptional("external_urls")
     ...
     *   server responded with an unexpected value).
     */
    fun isPlayable(): Optional<Boolean> = isPlayable.getOptional("is_playable")
     ...
     *   server responded with an unexpected value).
     */
    fun restrictions(): Optional<TrackRestrictionObject> = restrictions.getOptional("restrictions")
     ...
     *   server responded with an unexpected value).
     */
    fun trackNumber(): Optional<Long> = trackNumber.getOptional("track_number")
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (discNumber.asKnown().isPresent) 1 else 0) +
