...
private constructor(
     ...
     */
    fun albums(): Optional<Albums> = albums.getOptional("albums")

    /**
     * @throws SpottedInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun artists(): Optional<Artists> = artists.getOptional("artists")

    /**
     * @throws SpottedInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun audiobooks(): Optional<Audiobooks> = audiobooks.getOptional("audiobooks")

    /**
     * @throws SpottedInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun episodes(): Optional<Episodes> = episodes.getOptional("episodes")

    /**
     * @throws SpottedInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun playlists(): Optional<PagingPlaylistObject> = playlists.getOptional("playlists")

    /**
     * @throws SpottedInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun shows(): Optional<Shows> = shows.getOptional("shows")
    ...
    fun validate(): SearchQueryResponse = apply {
        ...
        albums().ifPresent { it.validate() }
        artists().ifPresent { it.validate() }
        audiobooks().ifPresent { it.validate() }
        episodes().ifPresent { it.validate() }
        playlists().ifPresent { it.validate() }
        shows().ifPresent { it.validate() }
    ...
    internal fun validity(): Int =
        (albums.asKnown().getOrNull()?.validity() ?: 0) +
            (artists.asKnown().getOrNull()?.validity() ?: 0) +
            (audiobooks.asKnown().getOrNull()?.validity() ?: 0) +
            (episodes.asKnown().getOrNull()?.validity() ?: 0) +
            (playlists.asKnown().getOrNull()?.validity() ?: 0) +
            (shows.asKnown().getOrNull()?.validity() ?: 0) +
    ...
    private constructor(
        ...
        private constructor(
             ...
             *   the server responded with an unexpected value).
             */
            fun restrictions(): Optional<AlbumRestrictionObject> =
            ...
            class AlbumType @JsonCreator private constructor(private val value: JsonField<String>) :
                 ...
                 * fields.
                 *
                 * @throws SpottedInvalidDataException if any value type in this object doesn't
        ...
        override fun toString() =
            "Albums{href=$href, limit=$limit, next=$next, offset=$offset, previous=$previous, total=$total, items=$items, published=$published, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun items(): Optional<List<ArtistObject>> = items.getOptional("items")
        ...
        override fun toString() =
            "Artists{href=$href, limit=$limit, next=$next, offset=$offset, previous=$previous, total=$total, items=$items, published=$published, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun items(): Optional<List<AudiobookBase>> = items.getOptional("items")
        ...
        class Builder internal constructor() {
            ...
            internal fun from(audiobooks: Audiobooks) = apply {
                ...
                published = audiobooks.published
        ...
        override fun toString() =
            "Audiobooks{href=$href, limit=$limit, next=$next, offset=$offset, previous=$previous, total=$total, items=$items, published=$published, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun items(): Optional<List<SimplifiedEpisodeObject>> = items.getOptional("items")
        ...
        override fun toString() =
            "Episodes{href=$href, limit=$limit, next=$next, offset=$offset, previous=$previous, total=$total, items=$items, published=$published, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun items(): Optional<List<ShowBase>> = items.getOptional("items")
        ...
        override fun toString() =
            "Shows{href=$href, limit=$limit, next=$next, offset=$offset, previous=$previous, total=$total, items=$items, published=$published, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun items(): Optional<List<TrackObject>> = items.getOptional("items")
