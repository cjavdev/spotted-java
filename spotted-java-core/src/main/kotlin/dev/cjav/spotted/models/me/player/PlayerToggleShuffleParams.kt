 ...
 * endpoints.
 */
class PlayerToggleShuffleParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PlayerToggleShuffleParams].
         *
    ...
    /** A builder for [PlayerToggleShuffleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(playerToggleShuffleParams: PlayerToggleShuffleParams) = apply {
            state = playerToggleShuffleParams.state
            deviceId = playerToggleShuffleParams.deviceId
            additionalHeaders = playerToggleShuffleParams.additionalHeaders.toBuilder()
            additionalQueryParams = playerToggleShuffleParams.additionalQueryParams.toBuilder()
            additionalBodyProperties =
                playerToggleShuffleParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PlayerToggleShuffleParams].
         *
         ...
         */
        fun build(): PlayerToggleShuffleParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PlayerToggleShuffleParams &&
            state == other.state &&
    ...
    override fun toString() =
        "PlayerToggleShuffleParams{state=$state, deviceId=$deviceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
