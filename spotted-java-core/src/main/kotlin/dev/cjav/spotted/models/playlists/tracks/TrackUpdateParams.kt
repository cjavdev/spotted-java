...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun rangeLength(): Optional<Long> = body.rangeLength()
     ...
     *   server responded with an unexpected value).
     */
    fun rangeStart(): Optional<Long> = body.rangeStart()
    ...
    companion object {
        ...
        @JvmStatic fun none(): TrackUpdateParams = builder().build()
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun rangeLength(): Optional<Long> = rangeLength.getOptional("range_length")
         ...
         *   server responded with an unexpected value).
         */
        fun rangeStart(): Optional<Long> = rangeStart.getOptional("range_start")
