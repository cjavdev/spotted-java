...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AlbumSaveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun build(): AlbumSaveParams =
            AlbumSaveParams(body.build(), additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "AlbumSaveParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
