...
private constructor(
    ...
    private val items: JsonField<List<EpisodeListResponse>>,
    ...
    private constructor(
        ...
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<EpisodeListResponse>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun items(): Optional<List<EpisodeListResponse>> = items.getOptional("items")
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<EpisodeListResponse>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EpisodeListPageResponse].
         *
    ...
    /** A builder for [EpisodeListPageResponse]. */
    class Builder internal constructor() {
        ...
        private var items: JsonField<MutableList<EpisodeListResponse>>? = null
        private var published: JsonField<Boolean> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(episodeListPageResponse: EpisodeListPageResponse) = apply {
            href = episodeListPageResponse.href
            limit = episodeListPageResponse.limit
            next = episodeListPageResponse.next
            offset = episodeListPageResponse.offset
            previous = episodeListPageResponse.previous
            total = episodeListPageResponse.total
            items = episodeListPageResponse.items.map { it.toMutableList() }
            published = episodeListPageResponse.published
            additionalProperties = episodeListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        fun items(items: List<EpisodeListResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<EpisodeListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun items(items: JsonField<List<EpisodeListResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [EpisodeListResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: EpisodeListResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [EpisodeListPageResponse].
         *
         ...
         */
        fun build(): EpisodeListPageResponse =
            EpisodeListPageResponse(
    ...
    fun validate(): EpisodeListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EpisodeListPageResponse &&
            href == other.href &&
            limit == other.limit &&
            next == other.next &&
            offset == other.offset &&
    ...
    override fun toString() =
        "EpisodeListPageResponse{href=$href, limit=$limit, next=$next, offset=$offset, previous=$previous, total=$total, items=$items, published=$published, additionalProperties=$additionalProperties}"
}
