...
private constructor(
    ...
    /**
     * A comma-separated list of keywords that will be used to filter the response. If not supplied,
     * all album types will be returned. <br/> Valid values are:<br/>- `album`<br/>- `single`<br/>-
     * `appears_on`<br/>- `compilation`<br/>For example: `include_groups=album,single`.
     */
    ...
    companion object {
        ...
        @JvmStatic fun none(): ArtistListAlbumsParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ArtistListAlbumsParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ArtistListAlbumsParams]. */
    class Builder internal constructor() {

        private var id: String? = null
        private var includeGroups: String? = null
        ...
        @JvmSynthetic
        internal fun from(artistListAlbumsParams: ArtistListAlbumsParams) = apply {
            id = artistListAlbumsParams.id
            includeGroups = artistListAlbumsParams.includeGroups
            limit = artistListAlbumsParams.limit
            market = artistListAlbumsParams.market
            offset = artistListAlbumsParams.offset
            additionalHeaders = artistListAlbumsParams.additionalHeaders.toBuilder()
            additionalQueryParams = artistListAlbumsParams.additionalQueryParams.toBuilder()
        }
         ...
         * supplied, all album types will be returned. <br/> Valid values are:<br/>- `album`<br/>-
         * `single`<br/>- `appears_on`<br/>- `compilation`<br/>For example:
        ...
        /**
         * Returns an immutable instance of [ArtistListAlbumsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ArtistListAlbumsParams =
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                includeGroups?.let { put("include_groups", it) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ArtistListAlbumsParams &&
            id == other.id &&
    ...
    override fun toString() =
        "ArtistListAlbumsParams{id=$id, includeGroups=$includeGroups, limit=$limit, market=$market, offset=$offset, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
