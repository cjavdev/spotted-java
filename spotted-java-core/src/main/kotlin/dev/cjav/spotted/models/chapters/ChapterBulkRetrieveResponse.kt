...
import dev.cjav.spotted.models.AudiobookBase
...
class ChapterBulkRetrieveResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val chapters: JsonField<List<Chapter>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        chapters: JsonField<List<Chapter>> = JsonMissing.of()
    ) : this(chapters, mutableMapOf())

    /**
     * @throws SpottedInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun chapters(): List<Chapter> = chapters.getRequired("chapters")
     ...
     */
    @JsonProperty("chapters") @ExcludeMissing fun _chapters(): JsonField<List<Chapter>> = chapters
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ChapterBulkRetrieveResponse].
         *
    ...
    /** A builder for [ChapterBulkRetrieveResponse]. */
    class Builder internal constructor() {

        private var chapters: JsonField<MutableList<Chapter>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(chapterBulkRetrieveResponse: ChapterBulkRetrieveResponse) = apply {
            chapters = chapterBulkRetrieveResponse.chapters.map { it.toMutableList() }
            additionalProperties = chapterBulkRetrieveResponse.additionalProperties.toMutableMap()
        }

        fun chapters(chapters: List<Chapter>) = chapters(JsonField.of(chapters))

        /**
         * Sets [Builder.chapters] to an arbitrary JSON value.
         *
         * You should usually call [Builder.chapters] with a well-typed `List<Chapter>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun chapters(chapters: JsonField<List<Chapter>>) = apply {
            this.chapters = chapters.map { it.toMutableList() }
        }

        /**
         * Adds a single [Chapter] to [chapters].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addChapter(chapter: Chapter) = apply {
            chapters =
                (chapters ?: JsonField.of(mutableListOf())).also {
                    checkKnown("chapters", it).add(chapter)
                }
        }
        ...
        /**
         * Returns an immutable instance of [ChapterBulkRetrieveResponse].
         *
         ...
         */
        fun build(): ChapterBulkRetrieveResponse =
            ChapterBulkRetrieveResponse(
                checkRequired("chapters", chapters).map { it.toImmutable() },
    ...
    fun validate(): ChapterBulkRetrieveResponse = apply {
        if (validated) {
            return@apply
        }

        chapters().forEach { it.validate() }
        validated = true
    }
    ...
    internal fun validity(): Int =
        (chapters.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
    ...
    private constructor(
        ...
        private val audiobook: JsonField<AudiobookBase>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            audiobook: JsonField<AudiobookBase> = JsonMissing.of(),
        ...
        fun audioPreviewUrl(): Optional<String> = audioPreviewUrl.getOptional("audio_preview_url")
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun audiobook(): AudiobookBase = audiobook.getRequired("audiobook")
         ...
         *   server responded with an unexpected value).
         */
        fun restrictions(): Optional<ChapterRestrictionObject> =
            restrictions.getOptional("restrictions")
         ...
         *   server responded with an unexpected value).
         */
        fun resumePoint(): Optional<ResumePointObject> = resumePoint.getOptional("resume_point")
         ...
         *
         * Unlike [audioPreviewUrl], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @Deprecated("deprecated")
        @JsonProperty("audio_preview_url")
        ...
        /**
         * Returns the raw JSON value of [audiobook].
         *
         * Unlike [audiobook], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("audiobook")
        @ExcludeMissing
        fun _audiobook(): JsonField<AudiobookBase> = audiobook

        /**
         * Returns the raw JSON value of [chapterNumber].
         *
         * Unlike [chapterNumber], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("chapter_number")
        @ExcludeMissing
        ...
        @JsonProperty("is_playable")
        @ExcludeMissing
        fun _isPlayable(): JsonField<Boolean> = isPlayable
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [Chapter].
             *
             * The following fields are required:
             * ```java
             * .id()
        ...
        /** A builder for [Chapter]. */
        class Builder internal constructor() {

            private var id: JsonField<String>? = null
            private var audioPreviewUrl: JsonField<String>? = null
            private var audiobook: JsonField<AudiobookBase>? = null
            ...
            @JvmSynthetic
            internal fun from(chapter: Chapter) = apply {
                id = chapter.id
                ...
                externalUrls = chapter.externalUrls
                href = chapter.href
                htmlDescription = chapter.htmlDescription
                images = chapter.images.map { it.toMutableList() }
                isPlayable = chapter.isPlayable
                languages = chapter.languages.map { it.toMutableList() }
                name = chapter.name
                releaseDate = chapter.releaseDate
                releaseDatePrecision = chapter.releaseDatePrecision
                type = chapter.type
                uri = chapter.uri
            ...
            /** Alias for calling [Builder.audioPreviewUrl] with `audioPreviewUrl.orElse(null)`. */
            @Deprecated("deprecated")
            fun audioPreviewUrl(audioPreviewUrl: Optional<String>) =
                audioPreviewUrl(audioPreviewUrl.getOrNull())
            ...
            /** The audiobook for which the chapter belongs. */
            fun audiobook(audiobook: AudiobookBase) = audiobook(JsonField.of(audiobook))

            /**
             * Sets [Builder.audiobook] to an arbitrary JSON value.
             *
             * You should usually call [Builder.audiobook] with a well-typed [AudiobookBase] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun audiobook(audiobook: JsonField<AudiobookBase>) = apply {
             ...
             *
             * You should usually call [Builder.chapterNumber] with a well-typed [Long] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Whether or not the chapter has explicit content (true = yes it does; false = no it
             * does not OR unknown).
             */
             ...
             *
             * You should usually call [Builder.isPlayable] with a well-typed [Boolean] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * [ChapterRestrictionObject] value instead. This method is primarily for setting the
             ...
             *
             * You should usually call [Builder.resumePoint] with a well-typed [ResumePointObject]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            ...
            /**
             * Returns an immutable instance of [Chapter].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
            ...
            fun build(): Chapter =
                Chapter(
                    ...
                    checkRequired("audiobook", audiobook),
        ...
        internal fun validity(): Int =
            (if (id.asKnown().isPresent) 1 else 0) +
                (if (audioPreviewUrl.asKnown().isPresent) 1 else 0) +
                (audiobook.asKnown().getOrNull()?.validity() ?: 0) +
                (if (chapterNumber.asKnown().isPresent) 1 else 0) +
                (if (description.asKnown().isPresent) 1 else 0) +
                (if (durationMs.asKnown().isPresent) 1 else 0) +
                (if (explicit.asKnown().isPresent) 1 else 0) +
                (externalUrls.asKnown().getOrNull()?.validity() ?: 0) +
                (if (href.asKnown().isPresent) 1 else 0) +
                (if (htmlDescription.asKnown().isPresent) 1 else 0) +
                (images.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
                (if (isPlayable.asKnown().isPresent) 1 else 0) +
                (languages.asKnown().getOrNull()?.size ?: 0) +
                (if (name.asKnown().isPresent) 1 else 0) +
                (if (releaseDate.asKnown().isPresent) 1 else 0) +
                (releaseDatePrecision.asKnown().getOrNull()?.validity() ?: 0) +
                type.let { if (it == JsonValue.from("episode")) 1 else 0 } +
                (if (uri.asKnown().isPresent) 1 else 0) +
                (availableMarkets.asKnown().getOrNull()?.size ?: 0) +
        ...
        private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                @JvmStatic fun of(value: String) = ReleaseDatePrecision(JsonField.of(value))
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChapterBulkRetrieveResponse &&
            chapters == other.chapters &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(chapters, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ChapterBulkRetrieveResponse{chapters=$chapters, additionalProperties=$additionalProperties}"
}
