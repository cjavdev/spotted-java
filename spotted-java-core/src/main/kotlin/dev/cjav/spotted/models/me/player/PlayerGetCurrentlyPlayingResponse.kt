...
class PlayerGetCurrentlyPlayingResponse
...
private constructor(
    ...
    /** A builder for [PlayerGetCurrentlyPlayingResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(playerGetCurrentlyPlayingResponse: PlayerGetCurrentlyPlayingResponse) =
            apply {
                actions = playerGetCurrentlyPlayingResponse.actions
                context = playerGetCurrentlyPlayingResponse.context
                currentlyPlayingType = playerGetCurrentlyPlayingResponse.currentlyPlayingType
        ...
        /**
         * Returns an immutable instance of [PlayerGetCurrentlyPlayingResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PlayerGetCurrentlyPlayingResponse =
            PlayerGetCurrentlyPlayingResponse(
                actions,
                context,
                currentlyPlayingType,
     ...
     *   expected type.
     */
    fun validate(): PlayerGetCurrentlyPlayingResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PlayerGetCurrentlyPlayingResponse &&
