...
class CategoryListPageResponse
...
private constructor(
    ...
    private val items: JsonField<List<CategoryListResponse>>,
    ...
    private constructor(
        ...
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<CategoryListResponse>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun items(): Optional<List<CategoryListResponse>> = items.getOptional("items")
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<CategoryListResponse>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CategoryListPageResponse].
         *
    ...
    /** A builder for [CategoryListPageResponse]. */
    class Builder internal constructor() {
        ...
        private var items: JsonField<MutableList<CategoryListResponse>>? = null
        private var published: JsonField<Boolean> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(categoryListPageResponse: CategoryListPageResponse) = apply {
            href = categoryListPageResponse.href
            limit = categoryListPageResponse.limit
            next = categoryListPageResponse.next
            offset = categoryListPageResponse.offset
            previous = categoryListPageResponse.previous
            total = categoryListPageResponse.total
            items = categoryListPageResponse.items.map { it.toMutableList() }
            published = categoryListPageResponse.published
            additionalProperties = categoryListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        fun items(items: List<CategoryListResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<CategoryListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun items(items: JsonField<List<CategoryListResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [CategoryListResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: CategoryListResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [CategoryListPageResponse].
         *
         ...
         */
        fun build(): CategoryListPageResponse =
    ...
    fun validate(): CategoryListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CategoryListPageResponse &&
            href == other.href &&
            limit == other.limit &&
            next == other.next &&
            offset == other.offset &&
    ...
    override fun toString() =
        "CategoryListPageResponse{href=$href, limit=$limit, next=$next, offset=$offset, previous=$previous, total=$total, items=$items, published=$published, additionalProperties=$additionalProperties}"
}
