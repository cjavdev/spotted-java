...
private constructor(
     ...
     * [ISO 639](https://en.wikipedia.org/wiki/ISO_639) code. This field is deprecated and might be
     ...
     *   server responded with an unexpected value).
     */
    fun restrictions(): Optional<EpisodeRestrictionObject> =
    ...
    @JsonProperty("restrictions")
    @ExcludeMissing
    fun _restrictions(): JsonField<EpisodeRestrictionObject> = restrictions
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SimplifiedEpisodeObject].
         *
    ...
    /** A builder for [SimplifiedEpisodeObject]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(simplifiedEpisodeObject: SimplifiedEpisodeObject) = apply {
            id = simplifiedEpisodeObject.id
            audioPreviewUrl = simplifiedEpisodeObject.audioPreviewUrl
            description = simplifiedEpisodeObject.description
            durationMs = simplifiedEpisodeObject.durationMs
            explicit = simplifiedEpisodeObject.explicit
            externalUrls = simplifiedEpisodeObject.externalUrls
            href = simplifiedEpisodeObject.href
            htmlDescription = simplifiedEpisodeObject.htmlDescription
            images = simplifiedEpisodeObject.images.map { it.toMutableList() }
            isExternallyHosted = simplifiedEpisodeObject.isExternallyHosted
            isPlayable = simplifiedEpisodeObject.isPlayable
            languages = simplifiedEpisodeObject.languages.map { it.toMutableList() }
            name = simplifiedEpisodeObject.name
            releaseDate = simplifiedEpisodeObject.releaseDate
            releaseDatePrecision = simplifiedEpisodeObject.releaseDatePrecision
            type = simplifiedEpisodeObject.type
            uri = simplifiedEpisodeObject.uri
            language = simplifiedEpisodeObject.language
            published = simplifiedEpisodeObject.published
            restrictions = simplifiedEpisodeObject.restrictions
            resumePoint = simplifiedEpisodeObject.resumePoint
            additionalProperties = simplifiedEpisodeObject.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Whether or not the episode has explicit content (true = yes it does; false = no it does
         * not OR unknown).
         */
        ...
        /**
         * The language used in the episode, identified by a
         * [ISO 639](https://en.wikipedia.org/wiki/ISO_639) code. This field is deprecated and might
         * be removed in the future. Please use the `languages` field instead.
         */
        @Deprecated("deprecated") fun language(language: String) = language(JsonField.of(language))
         ...
         * [EpisodeRestrictionObject] value instead. This method is primarily for setting the field
         * to an undocumented or not yet supported value.
         */
        fun restrictions(restrictions: JsonField<EpisodeRestrictionObject>) = apply {
        ...
        /**
         * Returns an immutable instance of [SimplifiedEpisodeObject].
         *
         ...
         */
        fun build(): SimplifiedEpisodeObject =
    ...
    fun validate(): SimplifiedEpisodeObject = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (isExternallyHosted.asKnown().isPresent) 1 else 0) +
