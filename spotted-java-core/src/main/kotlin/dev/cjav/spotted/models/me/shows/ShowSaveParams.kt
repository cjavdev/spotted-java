...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ShowSaveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun build(): ShowSaveParams =
            ShowSaveParams(body.build(), additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "ShowSaveParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
