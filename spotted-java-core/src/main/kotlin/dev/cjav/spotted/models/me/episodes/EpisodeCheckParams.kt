 ...
 * library.<br/> This API endpoint is in __beta__ and could change without warning. Please share any
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EpisodeCheckParams].
         *
    ...
    /** A builder for [EpisodeCheckParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(episodeCheckParams: EpisodeCheckParams) = apply {
            ids = episodeCheckParams.ids
            additionalHeaders = episodeCheckParams.additionalHeaders.toBuilder()
            additionalQueryParams = episodeCheckParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EpisodeCheckParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EpisodeCheckParams &&
            ids == other.ids &&
    ...
    override fun toString() =
        "EpisodeCheckParams{ids=$ids, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
