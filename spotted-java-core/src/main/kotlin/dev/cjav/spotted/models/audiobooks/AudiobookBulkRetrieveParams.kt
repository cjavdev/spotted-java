...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AudiobookBulkRetrieveParams].
         *
    ...
    /** A builder for [AudiobookBulkRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(audiobookBulkRetrieveParams: AudiobookBulkRetrieveParams) = apply {
            ids = audiobookBulkRetrieveParams.ids
            market = audiobookBulkRetrieveParams.market
            additionalHeaders = audiobookBulkRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = audiobookBulkRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AudiobookBulkRetrieveParams].
         *
         ...
         */
        fun build(): AudiobookBulkRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AudiobookBulkRetrieveParams &&
            ids == other.ids &&
            market == other.market &&
    ...
    override fun toString() =
        "AudiobookBulkRetrieveParams{ids=$ids, market=$market, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
