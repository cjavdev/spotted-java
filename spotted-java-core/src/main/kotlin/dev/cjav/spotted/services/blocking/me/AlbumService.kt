...
interface AlbumService {
    ...
    fun list(): AlbumListPage = list(AlbumListParams.none())
    ...
    /** @see list */
    fun list(params: AlbumListParams = AlbumListParams.none()): AlbumListPage =
     ...
     * library.
     */
    fun check(params: AlbumCheckParams): List<Boolean> = check(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * [AlbumService.list].
         */
        @MustBeClosed fun list(): HttpResponseFor<AlbumListPage> = list(AlbumListParams.none())
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: AlbumListParams = AlbumListParams.none()): HttpResponseFor<AlbumListPage> =
            list(params, RequestOptions.none())
         ...
         */
        @MustBeClosed
        fun check(params: AlbumCheckParams): HttpResponseFor<List<Boolean>> =
