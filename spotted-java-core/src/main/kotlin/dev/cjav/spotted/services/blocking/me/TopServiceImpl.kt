...
class TopServiceImpl internal constructor(private val clientOptions: ClientOptions) : TopService {
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): TopService =
        TopServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            TopServiceImpl.WithRawResponseImpl(
