...
class AudiobookServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AudiobookService =
        AudiobookServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
