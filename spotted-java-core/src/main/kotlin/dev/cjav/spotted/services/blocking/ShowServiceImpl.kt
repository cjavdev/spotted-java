...
class ShowServiceImpl internal constructor(private val clientOptions: ClientOptions) : ShowService {
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ShowService =
        ShowServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            ShowServiceImpl.WithRawResponseImpl(
