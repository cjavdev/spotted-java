...
interface TrackService {
    ...
    fun list(): TrackListPage = list(TrackListParams.none())
    ...
    /** @see list */
    fun list(params: TrackListParams = TrackListParams.none()): TrackListPage =
    ...
    interface WithRawResponse {
         ...
         * [TrackService.list].
         */
        @MustBeClosed fun list(): HttpResponseFor<TrackListPage> = list(TrackListParams.none())
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: TrackListParams = TrackListParams.none()): HttpResponseFor<TrackListPage> =
            list(params, RequestOptions.none())
