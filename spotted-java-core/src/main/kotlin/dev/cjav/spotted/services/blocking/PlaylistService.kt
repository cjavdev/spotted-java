...
interface PlaylistService {
    ...
    fun retrieve(playlistId: String): PlaylistRetrieveResponse =
    ...
    fun retrieve(
        playlistId: String,
        params: PlaylistRetrieveParams = PlaylistRetrieveParams.none(),
    ): PlaylistRetrieveResponse = retrieve(playlistId, params, RequestOptions.none())
    ...
    /** @see retrieve */
    fun retrieve(params: PlaylistRetrieveParams): PlaylistRetrieveResponse =
     ...
     * playlist.)
     */
    fun update(playlistId: String) = update(playlistId, PlaylistUpdateParams.none())
    ...
    /** @see update */
    fun update(playlistId: String, params: PlaylistUpdateParams = PlaylistUpdateParams.none()) =
    ...
    /** @see update */
    fun update(params: PlaylistUpdateParams) = update(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun retrieve(playlistId: String): HttpResponseFor<PlaylistRetrieveResponse> =
            retrieve(playlistId, PlaylistRetrieveParams.none())
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: PlaylistRetrieveParams): HttpResponseFor<PlaylistRetrieveResponse> =
            retrieve(params, RequestOptions.none())
         ...
         */
        @MustBeClosed
        fun update(playlistId: String): HttpResponse =
        ...
        fun update(
            playlistId: String,
            params: PlaylistUpdateParams = PlaylistUpdateParams.none(),
        ): HttpResponse = update(playlistId, params, RequestOptions.none())
        ...
        /** @see update */
        @MustBeClosed
        fun update(params: PlaylistUpdateParams): HttpResponse =
