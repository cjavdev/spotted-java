...
interface CategoryService {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): CategoryService
    ...
    fun retrieve(categoryId: String): CategoryRetrieveResponse =
    ...
    fun retrieve(
        categoryId: String,
        params: CategoryRetrieveParams = CategoryRetrieveParams.none(),
    ): CategoryRetrieveResponse = retrieve(categoryId, params, RequestOptions.none())
    ...
    /** @see retrieve */
    @Deprecated("deprecated")
    fun retrieve(params: CategoryRetrieveParams): CategoryRetrieveResponse =
     ...
     * “Browse” tab).
     */
    @Deprecated("deprecated") fun list(): CategoryListPage = list(CategoryListParams.none())
    ...
    @Deprecated("deprecated")
    fun getPlaylists(categoryId: String): CategoryGetPlaylistsResponse =
    ...
    fun getPlaylists(
        categoryId: String,
        params: CategoryGetPlaylistsParams = CategoryGetPlaylistsParams.none(),
    ): CategoryGetPlaylistsResponse = getPlaylists(categoryId, params, RequestOptions.none())
    ...
    /** @see getPlaylists */
    @Deprecated("deprecated")
    fun getPlaylists(params: CategoryGetPlaylistsParams): CategoryGetPlaylistsResponse =
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): CategoryService.WithRawResponse
        ...
        @Deprecated("deprecated")
        @MustBeClosed
        fun retrieve(categoryId: String): HttpResponseFor<CategoryRetrieveResponse> =
            retrieve(categoryId, CategoryRetrieveParams.none())
        ...
        @Deprecated("deprecated")
        @MustBeClosed
        fun retrieve(params: CategoryRetrieveParams): HttpResponseFor<CategoryRetrieveResponse> =
            retrieve(params, RequestOptions.none())
        ...
        @Deprecated("deprecated")
        @MustBeClosed
        fun getPlaylists(categoryId: String): HttpResponseFor<CategoryGetPlaylistsResponse> =
            getPlaylists(categoryId, CategoryGetPlaylistsParams.none())
