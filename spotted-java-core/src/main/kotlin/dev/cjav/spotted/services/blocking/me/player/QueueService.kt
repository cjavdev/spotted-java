...
interface QueueService {
     ...
     */
    fun add(params: QueueAddParams) = add(params, RequestOptions.none())

    /** @see add */
    fun add(params: QueueAddParams, requestOptions: RequestOptions = RequestOptions.none())

    /** Get the list of objects that make up the user's queue. */
    fun get(): QueueGetResponse = get(QueueGetParams.none())
    ...
    /** @see get */
    fun get(params: QueueGetParams = QueueGetParams.none()): QueueGetResponse =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun add(params: QueueAddParams): HttpResponse = add(params, RequestOptions.none())
         ...
         * [QueueService.get].
         */
        @MustBeClosed fun get(): HttpResponseFor<QueueGetResponse> = get(QueueGetParams.none())
        ...
        /** @see get */
        @MustBeClosed
        fun get(params: QueueGetParams = QueueGetParams.none()): HttpResponseFor<QueueGetResponse> =
            get(params, RequestOptions.none())
