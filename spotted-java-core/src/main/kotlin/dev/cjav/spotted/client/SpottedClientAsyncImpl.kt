...
class SpottedClientAsyncImpl(private val clientOptions: ClientOptions) : SpottedClientAsync {
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SpottedClientAsync =
        SpottedClientAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
