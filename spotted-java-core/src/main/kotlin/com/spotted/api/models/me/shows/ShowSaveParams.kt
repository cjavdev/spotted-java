...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ShowSaveParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(showSaveParams: ShowSaveParams) = apply {
            queryIds = showSaveParams.queryIds
            body = showSaveParams.body.toBuilder()
            additionalHeaders = showSaveParams.additionalHeaders.toBuilder()
            additionalQueryParams = showSaveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ShowSaveParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ShowSaveParams &&
    ...
    override fun toString() =
        "ShowSaveParams{queryIds=$queryIds, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
