...
private constructor(
     ...
     */
    fun market(): Optional<String> = Optional.ofNullable(market)
     ...
     * instrumental.
     */
    fun maxAcousticness(): Optional<Double> = Optional.ofNullable(maxAcousticness)
     ...
     * instrumental.
     */
    fun maxDanceability(): Optional<Double> = Optional.ofNullable(maxDanceability)
     ...
     * instrumental.
     */
    fun maxDurationMs(): Optional<Long> = Optional.ofNullable(maxDurationMs)
     ...
     * instrumental.
     */
    fun maxEnergy(): Optional<Double> = Optional.ofNullable(maxEnergy)
     ...
     * instrumental.
     */
    fun maxInstrumentalness(): Optional<Double> = Optional.ofNullable(maxInstrumentalness)
     ...
     * instrumental.
     */
    fun maxKey(): Optional<Long> = Optional.ofNullable(maxKey)
     ...
     * instrumental.
     */
    fun maxLiveness(): Optional<Double> = Optional.ofNullable(maxLiveness)
     ...
     * instrumental.
     */
    fun maxLoudness(): Optional<Double> = Optional.ofNullable(maxLoudness)
     ...
     * instrumental.
     */
    fun maxMode(): Optional<Long> = Optional.ofNullable(maxMode)
     ...
     * instrumental.
     */
    fun maxPopularity(): Optional<Long> = Optional.ofNullable(maxPopularity)
     ...
     * instrumental.
     */
    fun maxSpeechiness(): Optional<Double> = Optional.ofNullable(maxSpeechiness)
     ...
     * instrumental.
     */
    fun maxTempo(): Optional<Double> = Optional.ofNullable(maxTempo)
     ...
     * instrumental.
     */
    fun maxTimeSignature(): Optional<Long> = Optional.ofNullable(maxTimeSignature)
     ...
     * instrumental.
     */
    fun maxValence(): Optional<Double> = Optional.ofNullable(maxValence)
     ...
     * beats per minute.
     */
    fun minAcousticness(): Optional<Double> = Optional.ofNullable(minAcousticness)
     ...
     * beats per minute.
     */
    fun minDanceability(): Optional<Double> = Optional.ofNullable(minDanceability)
     ...
     * beats per minute.
     */
    fun minDurationMs(): Optional<Long> = Optional.ofNullable(minDurationMs)
     ...
     * beats per minute.
     */
    fun minEnergy(): Optional<Double> = Optional.ofNullable(minEnergy)
     ...
     * beats per minute.
     */
    fun minInstrumentalness(): Optional<Double> = Optional.ofNullable(minInstrumentalness)
     ...
     * beats per minute.
     */
    fun minKey(): Optional<Long> = Optional.ofNullable(minKey)
     ...
     * beats per minute.
     */
    fun minLiveness(): Optional<Double> = Optional.ofNullable(minLiveness)
     ...
     * beats per minute.
     */
    fun minLoudness(): Optional<Double> = Optional.ofNullable(minLoudness)
     ...
     * beats per minute.
     */
    fun minMode(): Optional<Long> = Optional.ofNullable(minMode)
     ...
     * beats per minute.
     */
    fun minPopularity(): Optional<Long> = Optional.ofNullable(minPopularity)
     ...
     * beats per minute.
     */
    fun minSpeechiness(): Optional<Double> = Optional.ofNullable(minSpeechiness)
     ...
     * beats per minute.
     */
    fun minTempo(): Optional<Double> = Optional.ofNullable(minTempo)
     ...
     * beats per minute.
     */
    fun minTimeSignature(): Optional<Long> = Optional.ofNullable(minTimeSignature)
     ...
     * beats per minute.
     */
    fun minValence(): Optional<Double> = Optional.ofNullable(minValence)
     ...
     */
    fun seedArtists(): Optional<String> = Optional.ofNullable(seedArtists)
     ...
     * set_.
     */
    fun seedGenres(): Optional<String> = Optional.ofNullable(seedGenres)
     ...
     */
    fun seedTracks(): Optional<String> = Optional.ofNullable(seedTracks)
     ...
     */
    fun targetAcousticness(): Optional<Double> = Optional.ofNullable(targetAcousticness)
     ...
     * equally in ranking results.
     */
    fun targetDanceability(): Optional<Double> = Optional.ofNullable(targetDanceability)

    /** Target duration of the track (ms) */
    fun targetDurationMs(): Optional<Long> = Optional.ofNullable(targetDurationMs)
     ...
     * equally in ranking results.
     */
    fun targetEnergy(): Optional<Double> = Optional.ofNullable(targetEnergy)
     ...
     * equally in ranking results.
     */
    fun targetInstrumentalness(): Optional<Double> = Optional.ofNullable(targetInstrumentalness)
     ...
     * equally in ranking results.
     */
    fun targetKey(): Optional<Long> = Optional.ofNullable(targetKey)
     ...
     * equally in ranking results.
     */
    fun targetLiveness(): Optional<Double> = Optional.ofNullable(targetLiveness)
     ...
     * equally in ranking results.
     */
    fun targetLoudness(): Optional<Double> = Optional.ofNullable(targetLoudness)
     ...
     * equally in ranking results.
     */
    fun targetMode(): Optional<Long> = Optional.ofNullable(targetMode)
     ...
     * equally in ranking results.
     */
    fun targetPopularity(): Optional<Long> = Optional.ofNullable(targetPopularity)
     ...
     * equally in ranking results.
     */
    fun targetSpeechiness(): Optional<Double> = Optional.ofNullable(targetSpeechiness)

    /** Target tempo (BPM) */
    fun targetTempo(): Optional<Double> = Optional.ofNullable(targetTempo)
     ...
     * equally in ranking results.
     */
    fun targetTimeSignature(): Optional<Long> = Optional.ofNullable(targetTimeSignature)
     ...
     * equally in ranking results.
     */
    fun targetValence(): Optional<Double> = Optional.ofNullable(targetValence)
    ...
    companion object {
        ...
        @JvmStatic fun none(): RecommendationGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun market(market: Optional<String>) = market(market.getOrNull())
        ...
        /** Alias for calling [Builder.maxAcousticness] with `maxAcousticness.orElse(null)`. */
        fun maxAcousticness(maxAcousticness: Optional<Double>) =
            maxAcousticness(maxAcousticness.getOrNull())
        ...
        /** Alias for calling [Builder.maxDanceability] with `maxDanceability.orElse(null)`. */
        fun maxDanceability(maxDanceability: Optional<Double>) =
            maxDanceability(maxDanceability.getOrNull())
        ...
        /** Alias for calling [Builder.maxDurationMs] with `maxDurationMs.orElse(null)`. */
        fun maxDurationMs(maxDurationMs: Optional<Long>) = maxDurationMs(maxDurationMs.getOrNull())
        ...
        /** Alias for calling [Builder.maxEnergy] with `maxEnergy.orElse(null)`. */
        fun maxEnergy(maxEnergy: Optional<Double>) = maxEnergy(maxEnergy.getOrNull())
        ...
        /**
         * Alias for calling [Builder.maxInstrumentalness] with `maxInstrumentalness.orElse(null)`.
         */
        fun maxInstrumentalness(maxInstrumentalness: Optional<Double>) =
            maxInstrumentalness(maxInstrumentalness.getOrNull())
        ...
        /** Alias for calling [Builder.maxKey] with `maxKey.orElse(null)`. */
        fun maxKey(maxKey: Optional<Long>) = maxKey(maxKey.getOrNull())
        ...
        /** Alias for calling [Builder.maxLiveness] with `maxLiveness.orElse(null)`. */
        fun maxLiveness(maxLiveness: Optional<Double>) = maxLiveness(maxLiveness.getOrNull())
        ...
        /** Alias for calling [Builder.maxLoudness] with `maxLoudness.orElse(null)`. */
        fun maxLoudness(maxLoudness: Optional<Double>) = maxLoudness(maxLoudness.getOrNull())
        ...
        /** Alias for calling [Builder.maxMode] with `maxMode.orElse(null)`. */
        fun maxMode(maxMode: Optional<Long>) = maxMode(maxMode.getOrNull())
        ...
        /** Alias for calling [Builder.maxPopularity] with `maxPopularity.orElse(null)`. */
        fun maxPopularity(maxPopularity: Optional<Long>) = maxPopularity(maxPopularity.getOrNull())
        ...
        /** Alias for calling [Builder.maxSpeechiness] with `maxSpeechiness.orElse(null)`. */
        fun maxSpeechiness(maxSpeechiness: Optional<Double>) =
            maxSpeechiness(maxSpeechiness.getOrNull())
        ...
        /** Alias for calling [Builder.maxTempo] with `maxTempo.orElse(null)`. */
        fun maxTempo(maxTempo: Optional<Double>) = maxTempo(maxTempo.getOrNull())
        ...
        /** Alias for calling [Builder.maxTimeSignature] with `maxTimeSignature.orElse(null)`. */
        fun maxTimeSignature(maxTimeSignature: Optional<Long>) =
            maxTimeSignature(maxTimeSignature.getOrNull())
        ...
        /** Alias for calling [Builder.maxValence] with `maxValence.orElse(null)`. */
        fun maxValence(maxValence: Optional<Double>) = maxValence(maxValence.getOrNull())
        ...
        /** Alias for calling [Builder.minAcousticness] with `minAcousticness.orElse(null)`. */
        fun minAcousticness(minAcousticness: Optional<Double>) =
            minAcousticness(minAcousticness.getOrNull())
        ...
        /** Alias for calling [Builder.minDanceability] with `minDanceability.orElse(null)`. */
        fun minDanceability(minDanceability: Optional<Double>) =
            minDanceability(minDanceability.getOrNull())
        ...
        /** Alias for calling [Builder.minDurationMs] with `minDurationMs.orElse(null)`. */
        fun minDurationMs(minDurationMs: Optional<Long>) = minDurationMs(minDurationMs.getOrNull())
        ...
        /** Alias for calling [Builder.minEnergy] with `minEnergy.orElse(null)`. */
        fun minEnergy(minEnergy: Optional<Double>) = minEnergy(minEnergy.getOrNull())
        ...
        /**
         * Alias for calling [Builder.minInstrumentalness] with `minInstrumentalness.orElse(null)`.
         */
        fun minInstrumentalness(minInstrumentalness: Optional<Double>) =
            minInstrumentalness(minInstrumentalness.getOrNull())
        ...
        /** Alias for calling [Builder.minKey] with `minKey.orElse(null)`. */
        fun minKey(minKey: Optional<Long>) = minKey(minKey.getOrNull())
        ...
        /** Alias for calling [Builder.minLiveness] with `minLiveness.orElse(null)`. */
        fun minLiveness(minLiveness: Optional<Double>) = minLiveness(minLiveness.getOrNull())
        ...
        /** Alias for calling [Builder.minLoudness] with `minLoudness.orElse(null)`. */
        fun minLoudness(minLoudness: Optional<Double>) = minLoudness(minLoudness.getOrNull())
        ...
        /** Alias for calling [Builder.minMode] with `minMode.orElse(null)`. */
        fun minMode(minMode: Optional<Long>) = minMode(minMode.getOrNull())
        ...
        /** Alias for calling [Builder.minPopularity] with `minPopularity.orElse(null)`. */
        fun minPopularity(minPopularity: Optional<Long>) = minPopularity(minPopularity.getOrNull())
        ...
        /** Alias for calling [Builder.minSpeechiness] with `minSpeechiness.orElse(null)`. */
        fun minSpeechiness(minSpeechiness: Optional<Double>) =
            minSpeechiness(minSpeechiness.getOrNull())
        ...
        /** Alias for calling [Builder.minTempo] with `minTempo.orElse(null)`. */
        fun minTempo(minTempo: Optional<Double>) = minTempo(minTempo.getOrNull())
        ...
        /** Alias for calling [Builder.minTimeSignature] with `minTimeSignature.orElse(null)`. */
        fun minTimeSignature(minTimeSignature: Optional<Long>) =
            minTimeSignature(minTimeSignature.getOrNull())
        ...
        /** Alias for calling [Builder.minValence] with `minValence.orElse(null)`. */
        fun minValence(minValence: Optional<Double>) = minValence(minValence.getOrNull())
        ...
        /** Alias for calling [Builder.seedArtists] with `seedArtists.orElse(null)`. */
        fun seedArtists(seedArtists: Optional<String>) = seedArtists(seedArtists.getOrNull())
        ...
        /** Alias for calling [Builder.seedGenres] with `seedGenres.orElse(null)`. */
        fun seedGenres(seedGenres: Optional<String>) = seedGenres(seedGenres.getOrNull())
        ...
        /** Alias for calling [Builder.seedTracks] with `seedTracks.orElse(null)`. */
        fun seedTracks(seedTracks: Optional<String>) = seedTracks(seedTracks.getOrNull())
        ...
        /**
         * Alias for calling [Builder.targetAcousticness] with `targetAcousticness.orElse(null)`.
         */
        fun targetAcousticness(targetAcousticness: Optional<Double>) =
            targetAcousticness(targetAcousticness.getOrNull())
        ...
        /**
         * Alias for calling [Builder.targetDanceability] with `targetDanceability.orElse(null)`.
         */
        fun targetDanceability(targetDanceability: Optional<Double>) =
            targetDanceability(targetDanceability.getOrNull())
        ...
        /** Alias for calling [Builder.targetDurationMs] with `targetDurationMs.orElse(null)`. */
        fun targetDurationMs(targetDurationMs: Optional<Long>) =
            targetDurationMs(targetDurationMs.getOrNull())
        ...
        /** Alias for calling [Builder.targetEnergy] with `targetEnergy.orElse(null)`. */
        fun targetEnergy(targetEnergy: Optional<Double>) = targetEnergy(targetEnergy.getOrNull())
        ...
        /**
         * Alias for calling [Builder.targetInstrumentalness] with
         * `targetInstrumentalness.orElse(null)`.
         */
        fun targetInstrumentalness(targetInstrumentalness: Optional<Double>) =
            targetInstrumentalness(targetInstrumentalness.getOrNull())
        ...
        /** Alias for calling [Builder.targetKey] with `targetKey.orElse(null)`. */
        fun targetKey(targetKey: Optional<Long>) = targetKey(targetKey.getOrNull())
        ...
        /** Alias for calling [Builder.targetLiveness] with `targetLiveness.orElse(null)`. */
        fun targetLiveness(targetLiveness: Optional<Double>) =
            targetLiveness(targetLiveness.getOrNull())
        ...
        /** Alias for calling [Builder.targetLoudness] with `targetLoudness.orElse(null)`. */
        fun targetLoudness(targetLoudness: Optional<Double>) =
            targetLoudness(targetLoudness.getOrNull())
        ...
        /** Alias for calling [Builder.targetMode] with `targetMode.orElse(null)`. */
        fun targetMode(targetMode: Optional<Long>) = targetMode(targetMode.getOrNull())
        ...
        /** Alias for calling [Builder.targetPopularity] with `targetPopularity.orElse(null)`. */
        fun targetPopularity(targetPopularity: Optional<Long>) =
            targetPopularity(targetPopularity.getOrNull())
        ...
        /** Alias for calling [Builder.targetSpeechiness] with `targetSpeechiness.orElse(null)`. */
        fun targetSpeechiness(targetSpeechiness: Optional<Double>) =
            targetSpeechiness(targetSpeechiness.getOrNull())
        ...
        /** Alias for calling [Builder.targetTempo] with `targetTempo.orElse(null)`. */
        fun targetTempo(targetTempo: Optional<Double>) = targetTempo(targetTempo.getOrNull())
        ...
        /**
         * Alias for calling [Builder.targetTimeSignature] with `targetTimeSignature.orElse(null)`.
         */
        fun targetTimeSignature(targetTimeSignature: Optional<Long>) =
            targetTimeSignature(targetTimeSignature.getOrNull())
        ...
        /** Alias for calling [Builder.targetValence] with `targetValence.orElse(null)`. */
        fun targetValence(targetValence: Optional<Double>) =
            targetValence(targetValence.getOrNull())
