...
class ArtistListAlbumsPageResponse
...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun items(): List<ArtistListAlbumsResponse> = items.getRequired("items")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ArtistListAlbumsPageResponse].
         *
    ...
    /** A builder for [ArtistListAlbumsPageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(artistListAlbumsPageResponse: ArtistListAlbumsPageResponse) = apply {
            href = artistListAlbumsPageResponse.href
            items = artistListAlbumsPageResponse.items.map { it.toMutableList() }
            limit = artistListAlbumsPageResponse.limit
            next = artistListAlbumsPageResponse.next
            offset = artistListAlbumsPageResponse.offset
        ...
        fun items(items: List<ArtistListAlbumsResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed
         * `List<ArtistListAlbumsResponse>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun items(items: JsonField<List<ArtistListAlbumsResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [ArtistListAlbumsResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: ArtistListAlbumsResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [ArtistListAlbumsPageResponse].
         *
         ...
         */
        fun build(): ArtistListAlbumsPageResponse =
            ArtistListAlbumsPageResponse(
    ...
    fun validate(): ArtistListAlbumsPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ArtistListAlbumsPageResponse &&
            href == other.href &&
            items == other.items &&
            limit == other.limit &&
            next == other.next &&
    ...
    override fun toString() =
        "ArtistListAlbumsPageResponse{href=$href, items=$items, limit=$limit, next=$next, offset=$offset, previous=$previous, total=$total, additionalProperties=$additionalProperties}"
}
