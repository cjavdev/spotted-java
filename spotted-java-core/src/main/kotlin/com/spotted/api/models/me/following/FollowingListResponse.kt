...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FollowingListResponse].
         *
    ...
    /** A builder for [FollowingListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(followingListResponse: FollowingListResponse) = apply {
            artists = followingListResponse.artists
            additionalProperties = followingListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FollowingListResponse].
         *
         ...
         */
        fun build(): FollowingListResponse =
    ...
    fun validate(): FollowingListResponse = apply {
        if (validated) {
            return@apply
        }
     ...
     */
    @JvmSynthetic internal fun validity(): Int = (artists.asKnown().getOrNull()?.validity() ?: 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FollowingListResponse &&
    ...
    override fun toString() =
        "FollowingListResponse{artists=$artists, additionalProperties=$additionalProperties}"
}
