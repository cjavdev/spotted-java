...
class AudioFeatureListResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val audioFeatures: JsonField<List<AudioFeature>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        audioFeatures: JsonField<List<AudioFeature>> = JsonMissing.of()
    ) : this(audioFeatures, mutableMapOf())

    /**
     * @throws SpottedInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun audioFeatures(): List<AudioFeature> = audioFeatures.getRequired("audio_features")

    /**
     * Returns the raw JSON value of [audioFeatures].
     *
     * Unlike [audioFeatures], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("audio_features")
    @ExcludeMissing
    fun _audioFeatures(): JsonField<List<AudioFeature>> = audioFeatures
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AudioFeatureListResponse].
         *
    ...
    /** A builder for [AudioFeatureListResponse]. */
    class Builder internal constructor() {

        private var audioFeatures: JsonField<MutableList<AudioFeature>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(audioFeatureListResponse: AudioFeatureListResponse) = apply {
            audioFeatures = audioFeatureListResponse.audioFeatures.map { it.toMutableList() }
            additionalProperties = audioFeatureListResponse.additionalProperties.toMutableMap()
        }

        fun audioFeatures(audioFeatures: List<AudioFeature>) =
            audioFeatures(JsonField.of(audioFeatures))

        /**
         * Sets [Builder.audioFeatures] to an arbitrary JSON value.
         *
         * You should usually call [Builder.audioFeatures] with a well-typed `List<AudioFeature>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun audioFeatures(audioFeatures: JsonField<List<AudioFeature>>) = apply {
            this.audioFeatures = audioFeatures.map { it.toMutableList() }
        }

        /**
         * Adds a single [AudioFeature] to [audioFeatures].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addAudioFeature(audioFeature: AudioFeature) = apply {
            audioFeatures =
                (audioFeatures ?: JsonField.of(mutableListOf())).also {
                    checkKnown("audioFeatures", it).add(audioFeature)
                }
        }
        ...
        /**
         * Returns an immutable instance of [AudioFeatureListResponse].
         *
         ...
         */
        fun build(): AudioFeatureListResponse =
            AudioFeatureListResponse(
                checkRequired("audioFeatures", audioFeatures).map { it.toImmutable() },
    ...
    fun validate(): AudioFeatureListResponse = apply {
        if (validated) {
            return@apply
        }

        audioFeatures().forEach { it.validate() }
        validated = true
    }
    ...
    internal fun validity(): Int =
        (audioFeatures.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            trackHref: JsonField<String> = JsonMissing.of(),
         ...
         *   server responded with an unexpected value).
         */
        fun acousticness(): Optional<Float> = acousticness.getOptional("acousticness")
         ...
         *   server responded with an unexpected value).
         */
        fun analysisUrl(): Optional<String> = analysisUrl.getOptional("analysis_url")
         ...
         *   server responded with an unexpected value).
         */
        fun danceability(): Optional<Float> = danceability.getOptional("danceability")
         ...
         *   server responded with an unexpected value).
         */
        fun energy(): Optional<Float> = energy.getOptional("energy")
         ...
         *   server responded with an unexpected value).
         */
        fun instrumentalness(): Optional<Float> = instrumentalness.getOptional("instrumentalness")
         ...
         *   server responded with an unexpected value).
         */
        fun key(): Optional<Long> = key.getOptional("key")
         ...
         *   server responded with an unexpected value).
         */
        fun liveness(): Optional<Float> = liveness.getOptional("liveness")
         ...
         *   server responded with an unexpected value).
         */
        fun loudness(): Optional<Float> = loudness.getOptional("loudness")
         ...
         *   server responded with an unexpected value).
         */
        fun speechiness(): Optional<Float> = speechiness.getOptional("speechiness")
         ...
         *   server responded with an unexpected value).
         */
        fun tempo(): Optional<Float> = tempo.getOptional("tempo")
         ...
         *   server responded with an unexpected value).
         */
        fun timeSignature(): Optional<Long> = timeSignature.getOptional("time_signature")
         ...
         *   server responded with an unexpected value).
         */
        fun trackHref(): Optional<String> = trackHref.getOptional("track_href")
         ...
         *   server responded with an unexpected value).
         */
        fun valence(): Optional<Float> = valence.getOptional("valence")
         ...
         *
         * Unlike [acousticness], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("acousticness")
        @ExcludeMissing
         ...
         *
         * Unlike [danceability], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("danceability")
        @ExcludeMissing
        ...
        @JsonProperty("speechiness")
        @ExcludeMissing
        fun _speechiness(): JsonField<Float> = speechiness
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [AudioFeature]. */
            @JvmStatic fun builder() = Builder()
        }

        /** A builder for [AudioFeature]. */
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(audioFeature: AudioFeature) = apply {
                id = audioFeature.id
                acousticness = audioFeature.acousticness
                analysisUrl = audioFeature.analysisUrl
                danceability = audioFeature.danceability
                durationMs = audioFeature.durationMs
                ...
                timeSignature = audioFeature.timeSignature
                trackHref = audioFeature.trackHref
                type = audioFeature.type
                uri = audioFeature.uri
                valence = audioFeature.valence
                additionalProperties = audioFeature.additionalProperties.toMutableMap()
            }
             ...
             *
             * You should usually call [Builder.acousticness] with a well-typed [Float] value
             ...
             *
             * You should usually call [Builder.analysisUrl] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun analysisUrl(analysisUrl: JsonField<String>) = apply {
             ...
             *
             * You should usually call [Builder.danceability] with a well-typed [Float] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.energy] with a well-typed [Float] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.liveness] with a well-typed [Float] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.speechiness] with a well-typed [Float] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun speechiness(speechiness: JsonField<Float>) = apply {
             ...
             *
             * You should usually call [Builder.valence] with a well-typed [Float] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Returns an immutable instance of [AudioFeature].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): AudioFeature =
                AudioFeature(
                    id,
                    acousticness,
                    analysisUrl,
        ...
        fun validate(): AudioFeature = apply {
            if (validated) {
                return@apply
            }
        ...
        internal fun validity(): Int =
            (if (id.asKnown().isPresent) 1 else 0) +
                (if (acousticness.asKnown().isPresent) 1 else 0) +
                (if (analysisUrl.asKnown().isPresent) 1 else 0) +
                (if (danceability.asKnown().isPresent) 1 else 0) +
                (if (durationMs.asKnown().isPresent) 1 else 0) +
                (if (energy.asKnown().isPresent) 1 else 0) +
                (if (instrumentalness.asKnown().isPresent) 1 else 0) +
                ...
                (if (trackHref.asKnown().isPresent) 1 else 0) +
                (type.asKnown().getOrNull()?.validity() ?: 0) +
                (if (uri.asKnown().isPresent) 1 else 0) +
                (if (valence.asKnown().isPresent) 1 else 0)
        ...
        class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                @JvmField val AUDIO_FEATURES = of("audio_features")
            ...
            fun asString(): String =
                _value().asString().orElseThrow {
                    SpottedInvalidDataException("Value is not a String")
                }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AudioFeatureListResponse &&
            audioFeatures == other.audioFeatures &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(audioFeatures, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "AudioFeatureListResponse{audioFeatures=$audioFeatures, additionalProperties=$additionalProperties}"
}
