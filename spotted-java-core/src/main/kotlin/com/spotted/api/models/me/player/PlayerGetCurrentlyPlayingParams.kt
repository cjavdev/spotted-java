...
class PlayerGetCurrentlyPlayingParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PlayerGetCurrentlyPlayingParams = builder().build()
    ...
    /** A builder for [PlayerGetCurrentlyPlayingParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(playerGetCurrentlyPlayingParams: PlayerGetCurrentlyPlayingParams) =
            apply {
                additionalTypes = playerGetCurrentlyPlayingParams.additionalTypes
                market = playerGetCurrentlyPlayingParams.market
                additionalHeaders = playerGetCurrentlyPlayingParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    playerGetCurrentlyPlayingParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [PlayerGetCurrentlyPlayingParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PlayerGetCurrentlyPlayingParams =
            PlayerGetCurrentlyPlayingParams(
                additionalTypes,
                market,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PlayerGetCurrentlyPlayingParams &&
    ...
    override fun toString() =
        "PlayerGetCurrentlyPlayingParams{additionalTypes=$additionalTypes, market=$market, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
