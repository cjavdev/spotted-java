...
private constructor(
    ...
    override fun toString() =
        "EpisodeListPageResponse{href=$href, limit=$limit, next=$next, offset=$offset, previous=$previous, total=$total, items=$items, additionalProperties=$additionalProperties}"
}
