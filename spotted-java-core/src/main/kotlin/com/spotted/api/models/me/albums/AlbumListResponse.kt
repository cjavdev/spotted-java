...
private constructor(
    ...
    ) : this(addedAt, album, mutableMapOf())
     ...
     *   server responded with an unexpected value).
     */
    fun album(): Optional<Album> = album.getOptional("album")
    ...
    class Builder internal constructor() {
        ...
        internal fun from(albumListResponse: AlbumListResponse) = apply {
            addedAt = albumListResponse.addedAt
        ...
        fun build(): AlbumListResponse =
            AlbumListResponse(addedAt, album, additionalProperties.toMutableMap())
    }
    ...
    internal fun validity(): Int =
        (if (addedAt.asKnown().isPresent) 1 else 0) + (album.asKnown().getOrNull()?.validity() ?: 0)
    ...
    private val hashCode: Int by lazy { Objects.hash(addedAt, album, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "AlbumListResponse{addedAt=$addedAt, album=$album, additionalProperties=$additionalProperties}"
}
