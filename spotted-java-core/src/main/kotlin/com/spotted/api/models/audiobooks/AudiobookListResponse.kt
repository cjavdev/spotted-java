...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(audiobookListResponse: AudiobookListResponse) = apply {
            audiobooks = audiobookListResponse.audiobooks.map { it.toMutableList() }
    ...
    internal fun validity(): Int =
        (audiobooks.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
    ...
    override fun toString() =
        "AudiobookListResponse{audiobooks=$audiobooks, additionalProperties=$additionalProperties}"
}
