...
private constructor(
     ...
     */
    fun bodyIds(): Optional<List<String>> = body.bodyIds()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EpisodeRemoveParams].
         *
    ...
    /** A builder for [EpisodeRemoveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(episodeRemoveParams: EpisodeRemoveParams) = apply {
            queryIds = episodeRemoveParams.queryIds
            body = episodeRemoveParams.body.toBuilder()
            additionalHeaders = episodeRemoveParams.additionalHeaders.toBuilder()
            additionalQueryParams = episodeRemoveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EpisodeRemoveParams].
         *
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun bodyIds(): Optional<List<String>> = bodyIds.getOptional("ids")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EpisodeRemoveParams &&
    ...
    override fun toString() =
        "EpisodeRemoveParams{queryIds=$queryIds, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
