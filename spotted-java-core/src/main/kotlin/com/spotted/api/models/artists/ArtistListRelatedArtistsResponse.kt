...
class ArtistListRelatedArtistsResponse
...
private constructor(
    ...
    /** A builder for [ArtistListRelatedArtistsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(artistListRelatedArtistsResponse: ArtistListRelatedArtistsResponse) =
            apply {
                artists = artistListRelatedArtistsResponse.artists.map { it.toMutableList() }
                additionalProperties =
                    artistListRelatedArtistsResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ArtistListRelatedArtistsResponse].
         *
         ...
         */
        fun build(): ArtistListRelatedArtistsResponse =
            ArtistListRelatedArtistsResponse(
    ...
    fun validate(): ArtistListRelatedArtistsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ArtistListRelatedArtistsResponse &&
    ...
    override fun toString() =
        "ArtistListRelatedArtistsResponse{artists=$artists, additionalProperties=$additionalProperties}"
}
