...
private constructor(
    ...
    override fun toString() =
        "ShowListEpisodesPageResponse{href=$href, limit=$limit, next=$next, offset=$offset, previous=$previous, total=$total, items=$items, additionalProperties=$additionalProperties}"
}
