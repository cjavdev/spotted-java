...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(audiobookListParams: AudiobookListParams) = apply {
            ids = audiobookListParams.ids
            market = audiobookListParams.market
    ...
    override fun toString() =
        "AudiobookListParams{ids=$ids, market=$market, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
