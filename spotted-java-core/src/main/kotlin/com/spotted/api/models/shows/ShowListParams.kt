...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(showListParams: ShowListParams) = apply {
            ids = showListParams.ids
            market = showListParams.market
    ...
    override fun toString() =
        "ShowListParams{ids=$ids, market=$market, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
