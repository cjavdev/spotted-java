...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun show(): ShowBase = show.getRequired("show")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EpisodeObject].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(episodeObject: EpisodeObject) = apply {
            id = episodeObject.id
            audioPreviewUrl = episodeObject.audioPreviewUrl
            description = episodeObject.description
            durationMs = episodeObject.durationMs
            explicit = episodeObject.explicit
            externalUrls = episodeObject.externalUrls
            href = episodeObject.href
            htmlDescription = episodeObject.htmlDescription
            images = episodeObject.images.map { it.toMutableList() }
            isExternallyHosted = episodeObject.isExternallyHosted
            isPlayable = episodeObject.isPlayable
            languages = episodeObject.languages.map { it.toMutableList() }
            name = episodeObject.name
            releaseDate = episodeObject.releaseDate
            releaseDatePrecision = episodeObject.releaseDatePrecision
        ...
        /**
         * Returns an immutable instance of [EpisodeObject].
         *
    ...
    fun validate(): EpisodeObject = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (show.asKnown().getOrNull()?.validity() ?: 0) +
