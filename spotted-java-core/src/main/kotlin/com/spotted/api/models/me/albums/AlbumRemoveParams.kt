...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AlbumRemoveParams].
         *
    ...
    /** A builder for [AlbumRemoveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(albumRemoveParams: AlbumRemoveParams) = apply {
            queryIds = albumRemoveParams.queryIds
            body = albumRemoveParams.body.toBuilder()
            additionalHeaders = albumRemoveParams.additionalHeaders.toBuilder()
            additionalQueryParams = albumRemoveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AlbumRemoveParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AlbumRemoveParams &&
    ...
    override fun toString() =
        "AlbumRemoveParams{queryIds=$queryIds, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
