...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserRetrieveProfileResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [UserRetrieveProfileResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userRetrieveProfileResponse: UserRetrieveProfileResponse) = apply {
            id = userRetrieveProfileResponse.id
            displayName = userRetrieveProfileResponse.displayName
            externalUrls = userRetrieveProfileResponse.externalUrls
        ...
        /**
         * Returns an immutable instance of [UserRetrieveProfileResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UserRetrieveProfileResponse =
    ...
    fun validate(): UserRetrieveProfileResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserRetrieveProfileResponse &&
            id == other.id &&
