...
private constructor(
     ...
     * `medium_term`
     */
    fun timeRange(): Optional<String> = Optional.ofNullable(timeRange)
    ...
    companion object {
        ...
        @JvmStatic fun none(): TopListTopTracksParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TopListTopTracksParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TopListTopTracksParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(topListTopTracksParams: TopListTopTracksParams) = apply {
            limit = topListTopTracksParams.limit
            offset = topListTopTracksParams.offset
            timeRange = topListTopTracksParams.timeRange
            additionalHeaders = topListTopTracksParams.additionalHeaders.toBuilder()
            additionalQueryParams = topListTopTracksParams.additionalQueryParams.toBuilder()
        }
        ...
        fun timeRange(timeRange: Optional<String>) = timeRange(timeRange.getOrNull())
        ...
        /**
         * Returns an immutable instance of [TopListTopTracksParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TopListTopTracksParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TopListTopTracksParams &&
            limit == other.limit &&
            offset == other.offset &&
    ...
    override fun toString() =
        "TopListTopTracksParams{limit=$limit, offset=$offset, timeRange=$timeRange, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
