...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ChapterListResponse].
         *
    ...
    /** A builder for [ChapterListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(chapterListResponse: ChapterListResponse) = apply {
            chapters = chapterListResponse.chapters.map { it.toMutableList() }
            additionalProperties = chapterListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ChapterListResponse].
         *
    ...
    fun validate(): ChapterListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChapterListResponse &&
    ...
    override fun toString() =
        "ChapterListResponse{chapters=$chapters, additionalProperties=$additionalProperties}"
}
