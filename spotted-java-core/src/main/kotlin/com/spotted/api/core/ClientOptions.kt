...
import com.spotted.api.core.http.OAuth2HttpClient
import com.spotted.api.core.http.PhantomReachableClosingHttpClient
import com.spotted.api.core.http.QueryParams
import com.spotted.api.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Use the one published in `spotted-java-client-okhttp` or implement your own.
     *
     ...
     *
     * Defaults to [com.spotted.api.core.jsonMapper]. The default is usually sufficient and rarely
    ...
    companion object {
        ...
        const val PRODUCTION_URL = "https://api.spotify.com/v1"
                            ...
                            object : ThreadFactory {
                                ...
                                override fun newThread(runnable: Runnable): Thread =
                                    threadFactory.newThread(runnable).also {
                                        it.name =
                                            "spotted-stream-handler-thread-${count.getAndIncrement()}"
                                    }
                            }
                        )
                    )
