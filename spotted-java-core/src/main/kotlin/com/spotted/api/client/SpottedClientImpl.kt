...
import com.spotted.api.services.blocking.AlbumServiceImpl
import com.spotted.api.services.blocking.ArtistService
import com.spotted.api.services.blocking.ArtistServiceImpl
import com.spotted.api.services.blocking.AudioAnalysisService
import com.spotted.api.services.blocking.AudioAnalysisServiceImpl
import com.spotted.api.services.blocking.AudioFeatureService
import com.spotted.api.services.blocking.AudioFeatureServiceImpl
import com.spotted.api.services.blocking.AudiobookService
import com.spotted.api.services.blocking.AudiobookServiceImpl
import com.spotted.api.services.blocking.BrowseService
import com.spotted.api.services.blocking.BrowseServiceImpl
import com.spotted.api.services.blocking.ChapterService
import com.spotted.api.services.blocking.ChapterServiceImpl
import com.spotted.api.services.blocking.EpisodeService
import com.spotted.api.services.blocking.EpisodeServiceImpl
import com.spotted.api.services.blocking.MarketService
import com.spotted.api.services.blocking.MarketServiceImpl
import com.spotted.api.services.blocking.MeService
import com.spotted.api.services.blocking.MeServiceImpl
import com.spotted.api.services.blocking.PlaylistService
import com.spotted.api.services.blocking.PlaylistServiceImpl
import com.spotted.api.services.blocking.RecommendationService
import com.spotted.api.services.blocking.RecommendationServiceImpl
import com.spotted.api.services.blocking.SearchService
import com.spotted.api.services.blocking.SearchServiceImpl
import com.spotted.api.services.blocking.ShowService
import com.spotted.api.services.blocking.ShowServiceImpl
import com.spotted.api.services.blocking.TrackService
import com.spotted.api.services.blocking.TrackServiceImpl
import com.spotted.api.services.blocking.UserService
import com.spotted.api.services.blocking.UserServiceImpl
...
class SpottedClientImpl(private val clientOptions: ClientOptions) : SpottedClient {
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SpottedClient =
        SpottedClientImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SpottedClientImpl.WithRawResponseImpl(
