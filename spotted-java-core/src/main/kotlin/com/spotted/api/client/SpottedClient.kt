...
interface SpottedClient {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): SpottedClient
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): SpottedClient.WithRawResponse
