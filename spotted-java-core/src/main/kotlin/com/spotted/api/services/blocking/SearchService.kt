...
interface SearchService {
     ...
     */
    fun query(params: SearchQueryParams): SearchQueryResponse = query(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun query(params: SearchQueryParams): HttpResponseFor<SearchQueryResponse> =
