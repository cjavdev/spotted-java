...
interface ChapterService {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): ChapterService
     ...
     */
    fun retrieve(id: String): ChapterRetrieveResponse = retrieve(id, ChapterRetrieveParams.none())
    ...
    fun retrieve(
        id: String,
        params: ChapterRetrieveParams = ChapterRetrieveParams.none(),
    ): ChapterRetrieveResponse = retrieve(id, params, RequestOptions.none())
    ...
    /** @see retrieve */
    fun retrieve(params: ChapterRetrieveParams): ChapterRetrieveResponse =
     ...
     * Australia markets.
     */
    fun list(params: ChapterListParams): ChapterListResponse = list(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): ChapterService.WithRawResponse
         ...
         */
        @MustBeClosed
        fun retrieve(id: String): HttpResponseFor<ChapterRetrieveResponse> =
        ...
        fun retrieve(
            id: String,
            params: ChapterRetrieveParams = ChapterRetrieveParams.none(),
        ): HttpResponseFor<ChapterRetrieveResponse> = retrieve(id, params, RequestOptions.none())
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: ChapterRetrieveParams): HttpResponseFor<ChapterRetrieveResponse> =
            retrieve(params, RequestOptions.none())
         ...
         */
        @MustBeClosed
        fun list(params: ChapterListParams): HttpResponseFor<ChapterListResponse> =
