...
interface RecommendationService {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): RecommendationService
    ...
    fun get(): RecommendationGetResponse = get(RecommendationGetParams.none())
    ...
    fun get(
        params: RecommendationGetParams = RecommendationGetParams.none()
    ): RecommendationGetResponse = get(params, RequestOptions.none())
     ...
     */
    @Deprecated("deprecated")
    fun listAvailableGenreSeeds(): RecommendationListAvailableGenreSeedsResponse =
    ...
    interface WithRawResponse {
        ...
        @Deprecated("deprecated")
        @MustBeClosed
        fun get(): HttpResponseFor<RecommendationGetResponse> = get(RecommendationGetParams.none())
        ...
        fun get(
            params: RecommendationGetParams = RecommendationGetParams.none()
        ): HttpResponseFor<RecommendationGetResponse> = get(params, RequestOptions.none())
