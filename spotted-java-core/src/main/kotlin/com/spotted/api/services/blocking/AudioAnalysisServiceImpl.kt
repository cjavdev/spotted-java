...
class AudioAnalysisServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AudioAnalysisService =
        AudioAnalysisServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
