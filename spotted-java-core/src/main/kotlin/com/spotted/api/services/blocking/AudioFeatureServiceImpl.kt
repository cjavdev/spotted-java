...
class AudioFeatureServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AudioFeatureService =
        AudioFeatureServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
