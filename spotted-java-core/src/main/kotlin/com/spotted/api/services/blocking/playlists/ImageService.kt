...
interface ImageService {
    ...
    fun list(
        playlistId: String,
        params: ImageListParams = ImageListParams.none(),
    ): List<ImageObject> = list(playlistId, params, RequestOptions.none())
    ...
    /** @see list */
    fun list(params: ImageListParams): List<ImageObject> = list(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(playlistId: String): HttpResponseFor<List<ImageObject>> =
        ...
        fun list(
            playlistId: String,
            params: ImageListParams = ImageListParams.none(),
        ): HttpResponseFor<List<ImageObject>> = list(playlistId, params, RequestOptions.none())
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: ImageListParams): HttpResponseFor<List<ImageObject>> =
