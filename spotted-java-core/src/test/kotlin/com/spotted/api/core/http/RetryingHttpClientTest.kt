package com.spotted.api.core.http

import com.github.tomakehurst.wiremock.client.WireMock.*
import com.github.tomakehurst.wiremock.junit5.WireMockRuntimeInfo
import com.github.tomakehurst.wiremock.junit5.WireMockTest
import com.github.tomakehurst.wiremock.stubbing.Scenario
import com.spotted.api.client.okhttp.OkHttpClient
import com.spotted.api.core.RequestOptions
import com.spotted.api.core.Sleeper
import com.spotted.api.errors.SpottedRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw SpottedRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            SpottedRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
