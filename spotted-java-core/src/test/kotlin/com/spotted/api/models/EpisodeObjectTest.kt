...
internal class EpisodeObjectTest {
    ...
    fun create() {
        ...
        assertThat(episodeObject.type()).isEqualTo(EpisodeObject.Type.EPISODE)
        assertThat(episodeObject.uri()).isEqualTo("spotify:episode:0zLhl3WsOCQHbe1BPTiHgr")
        assertThat(episodeObject.language()).contains("en")
        assertThat(episodeObject.restrictions())
            .contains(EpisodeRestrictionObject.builder().reason("reason").build())
