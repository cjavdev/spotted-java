...
internal class AlbumRetrieveResponseTest {
    ...
    fun create() {
        ...
        assertThat(albumRetrieveResponse.artists().getOrNull())
            .containsExactly(
                SimplifiedArtistObject.builder()
                    .id("id")
                    .externalUrls(ExternalUrlObject.builder().spotify("spotify").build())
        ...
        assertThat(albumRetrieveResponse.copyrights().getOrNull())
        ...
        assertThat(albumRetrieveResponse.genres().getOrNull()).containsExactly("string")
        assertThat(albumRetrieveResponse.label()).contains("label")
        assertThat(albumRetrieveResponse.popularity()).contains(0L)
