...
internal class SimplifiedEpisodeObjectTest {
    ...
    fun create() {
        ...
        assertThat(simplifiedEpisodeObject.language()).contains("en")
        assertThat(simplifiedEpisodeObject.published()).contains(true)
        assertThat(simplifiedEpisodeObject.restrictions())
            .contains(EpisodeRestrictionObject.builder().published(true).reason("reason").build())
