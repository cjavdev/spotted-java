    ...
    fun create() {
        val playlistRetrieveResponse =
            PlaylistRetrieveResponse.builder()
                ...
                .items(
                    PlaylistRetrieveResponse.Items.builder()
        ...
        assertThat(playlistRetrieveResponse.href()).contains("href")
        assertThat(playlistRetrieveResponse.images().getOrNull())
            .containsExactly(
                ImageObject.builder()
                    .height(300L)
                    .url("https://i.scdn.co/image/ab67616d00001e02ff9ca10b55ce82ae553c8228\n")
        ...
        assertThat(playlistRetrieveResponse.items())
            .contains(
                PlaylistRetrieveResponse.Items.builder()
                    .href("https://api.spotify.com/v1/me/shows?offset=0&limit=20\n")
                    .limit(20L)
        ...
        assertThat(playlistRetrieveResponse.name()).contains("name")
        ...
        assertThat(playlistRetrieveResponse.published()).contains(true)
        assertThat(playlistRetrieveResponse.snapshotId()).contains("snapshot_id")
        ...
        assertThat(playlistRetrieveResponse.type()).contains("type")
        assertThat(playlistRetrieveResponse.uri()).contains("uri")
    }
