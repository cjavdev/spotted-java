...
internal class AudiobookListPageResponseTest {
    ...
    fun create() {
                    ...
                    AudiobookListResponse.builder()
                        ...
                        .audiobook(
                            AudiobookListResponse.Audiobook.builder()
                                .id("id")
                                .addAuthor(
                                    AuthorObject.builder().name("name").published(true).build()
                                )
                                ...
                                .name("name")
                                .addNarrator(
                                    NarratorObject.builder().name("name").published(true).build()
                                )
                                .publisher("publisher")
                                .totalChapters(0L)
                                .uri("uri")
        ...
        assertThat(audiobookListPageResponse.published()).contains(true)
    }
