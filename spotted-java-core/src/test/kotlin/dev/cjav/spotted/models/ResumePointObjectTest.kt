...
internal class ResumePointObjectTest {
    ...
    fun create() {
        ...
        assertThat(resumePointObject.fullyPlayed()).contains(true)
        assertThat(resumePointObject.published()).contains(true)
        assertThat(resumePointObject.resumePositionMs()).contains(0L)
    }
