...
internal class AudiobookRetrieveResponseTest {
    ...
    fun create() {
        ...
        assertThat(audiobookRetrieveResponse.authors())
            .containsExactly(AuthorObject.builder().name("name").published(true).build())
        ...
        assertThat(audiobookRetrieveResponse.narrators())
            .containsExactly(NarratorObject.builder().name("name").published(true).build())
        ...
        assertThat(audiobookRetrieveResponse.edition()).contains("Unabridged")
        assertThat(audiobookRetrieveResponse.published()).contains(true)
