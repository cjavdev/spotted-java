...
internal class PlayerGetStateResponseTest {
    ...
    fun create() {
        ...
        assertThat(playerGetStateResponse.currentlyPlayingType()).contains("currently_playing_type")
        ...
        assertThat(playerGetStateResponse.isPlaying()).contains(true)
        ...
        assertThat(playerGetStateResponse.progressMs()).contains(0L)
        assertThat(playerGetStateResponse.published()).contains(true)
        assertThat(playerGetStateResponse.repeatState()).contains("repeat_state")
        assertThat(playerGetStateResponse.shuffleState()).contains(true)
        assertThat(playerGetStateResponse.timestamp()).contains(0L)
    }
