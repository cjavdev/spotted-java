...
internal class PlaylistTrackObjectTest {
    ...
    fun create() {
        ...
        assertThat(playlistTrackObject.isLocal()).contains(true)
        assertThat(playlistTrackObject.item())
            .contains(
                PlaylistTrackObject.Item.ofTrack(
                    TrackObject.builder()
                        .id("id")
                        .album(
                            TrackObject.Album.builder()
        ...
        assertThat(playlistTrackObject.published()).contains(true)
