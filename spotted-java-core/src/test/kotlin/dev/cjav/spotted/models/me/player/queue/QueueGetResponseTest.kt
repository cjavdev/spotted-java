...
internal class QueueGetResponseTest {

    @Test
    fun create() {
        val queueGetResponse =
            QueueGetResponse.builder()
                .currentlyPlaying(
                    TrackObject.builder()
                        .id("id")
                        .album(
        ...
        assertThat(queueGetResponse.currentlyPlaying())
            .contains(
                QueueGetResponse.CurrentlyPlaying.ofTrack(
                    TrackObject.builder()
                        .id("id")
                        .album(
                            TrackObject.Album.builder()
        ...
        assertThat(queueGetResponse.published()).contains(true)
        assertThat(queueGetResponse.queue().getOrNull())
            .containsExactly(
                QueueGetResponse.Queue.ofTrack(
                    TrackObject.builder()
                        .id("id")
                        .album(
                            TrackObject.Album.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedQueueGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(queueGetResponse),
                jacksonTypeRef<QueueGetResponse>(),
            )

        assertThat(roundtrippedQueueGetResponse).isEqualTo(queueGetResponse)
    }
}
