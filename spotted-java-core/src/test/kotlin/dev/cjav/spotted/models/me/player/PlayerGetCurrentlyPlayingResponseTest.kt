...
internal class PlayerGetCurrentlyPlayingResponseTest {
    ...
    fun create() {
        ...
        assertThat(playerGetCurrentlyPlayingResponse.currentlyPlayingType())
            .contains("currently_playing_type")
        assertThat(playerGetCurrentlyPlayingResponse.isPlaying()).contains(true)
        ...
        assertThat(playerGetCurrentlyPlayingResponse.progressMs()).contains(0L)
        assertThat(playerGetCurrentlyPlayingResponse.published()).contains(true)
        assertThat(playerGetCurrentlyPlayingResponse.timestamp()).contains(0L)
    }
