...
internal class AudioAnalysisRetrieveResponseTest {
    ...
    fun create() {
            ...
            AudioAnalysisRetrieveResponse.builder()
                ...
                .addSection(
                    AudioAnalysisRetrieveResponse.Section.builder()
                        ...
                        .keyConfidence(0.297)
                        .loudness(-14.938)
                        .mode(AudioAnalysisRetrieveResponse.Section.Mode.MODE_NO_RESULT)
        ...
        assertThat(audioAnalysisRetrieveResponse.bars().getOrNull())
            .containsExactly(
                TimeIntervalObject.builder()
                    .confidence(0.925)
                    .duration(2.18749)
        ...
        assertThat(audioAnalysisRetrieveResponse.beats().getOrNull())
            .containsExactly(
                TimeIntervalObject.builder()
                    .confidence(0.925)
                    .duration(2.18749)
        ...
        assertThat(audioAnalysisRetrieveResponse.published()).contains(true)
        assertThat(audioAnalysisRetrieveResponse.sections().getOrNull())
            .containsExactly(
                AudioAnalysisRetrieveResponse.Section.builder()
                    .confidence(1.0)
                    .duration(6.97092)
        ...
        assertThat(audioAnalysisRetrieveResponse.segments().getOrNull())
            .containsExactly(
                AudioAnalysisRetrieveResponse.Segment.builder()
                    .confidence(0.435)
                    .duration(0.19891)
        ...
        assertThat(audioAnalysisRetrieveResponse.tatums().getOrNull())
            .containsExactly(
                TimeIntervalObject.builder()
                    .confidence(0.925)
                    .duration(2.18749)
