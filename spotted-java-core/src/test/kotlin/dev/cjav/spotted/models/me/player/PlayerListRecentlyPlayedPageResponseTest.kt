...
internal class PlayerListRecentlyPlayedPageResponseTest {
    ...
    fun create() {
        ...
        assertThat(playerListRecentlyPlayedPageResponse.href()).contains("href")
        assertThat(playerListRecentlyPlayedPageResponse.items().getOrNull())
            .containsExactly(
                PlayerListRecentlyPlayedResponse.builder()
                    .context(
                        ContextObject.builder()
        ...
        assertThat(playerListRecentlyPlayedPageResponse.limit()).contains(0L)
        assertThat(playerListRecentlyPlayedPageResponse.next()).contains("next")
        assertThat(playerListRecentlyPlayedPageResponse.published()).contains(true)
        assertThat(playerListRecentlyPlayedPageResponse.total()).contains(0L)
    }
