...
internal class PlaylistCreateResponseTest {
    ...
    fun create() {
        ...
        assertThat(playlistCreateResponse.id()).contains("id")
        assertThat(playlistCreateResponse.componentsSchemasPropertiesPublished()).contains(true)
        assertThat(playlistCreateResponse.collaborative()).contains(true)
        assertThat(playlistCreateResponse.description()).contains("description")
        ...
        assertThat(playlistCreateResponse.href()).contains("href")
        assertThat(playlistCreateResponse.images().getOrNull())
            .containsExactly(
                ImageObject.builder()
                    .height(300L)
                    .url("https://i.scdn.co/image/ab67616d00001e02ff9ca10b55ce82ae553c8228\n")
        ...
        assertThat(playlistCreateResponse.name()).contains("name")
        ...
        assertThat(playlistCreateResponse.type()).contains("type")
        assertThat(playlistCreateResponse.uri()).contains("uri")
    }
